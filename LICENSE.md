...
====================================
This License is Derived from the CoFH "Don't Be a Jerk" License which can be found [here](https://github.com/CoFH/CoFHCore/blob/master/README.md).
...
**A jerk is anyone who attempts to or intends to claim partial or total ownership of the original or repackaged code and/or attempts to or intends to redistribute original or repackaged code without prior express written permission from the owners (Minecraftschurli).

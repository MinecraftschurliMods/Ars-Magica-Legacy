...
class AMAbilityProvider extends AbilityProvider {
    ...
    protected void createAbilities(Consumer<AbilityBuilder> consumer) {
        ...
        createAbility(AMAbilities.HASTE.get().getId(),                  AMAffinities.EARTH.get(),     Range.ofBounds(0.01, 1))  .build(consumer);
        createAbility(AMAbilities.FALL_DAMAGE.get().getId(),            AMAffinities.EARTH.get(),     Range.ofBounds(0.5, 1))   .build(consumer);
        createAbility(AMAbilities.JUMP_BOOST.get().getId(),             AMAffinities.AIR.get(),       Range.ofBounds(0.01, 1))  .build(consumer);
        createAbility(AMAbilities.FEATHER_FALLING.get().getId(),        AMAffinities.AIR.get(),       Range.ofBounds(0.01, 1))  .build(consumer);
        createAbility(AMAbilities.GRAVITY.get().getId(),                AMAffinities.AIR.get(),       Range.ofBounds(0.5, 1))   .build(consumer);
        createAbility(AMAbilities.FROST_PUNCH.get().getId(),            AMAffinities.ICE.get(),       Range.ofBounds(0.01, 1))  .build(consumer);
        ...
        createAbility(AMAbilities.SPEED.get().getId(),                  AMAffinities.LIGHTNING.get(), Range.ofBounds(0.01, 1))  .build(consumer);
        ...
        createAbility(AMAbilities.THORNS.get().getId(),                 AMAffinities.NATURE.get(),    Range.ofBounds(0.01, 1))  .build(consumer);
        ...
        createAbility(AMAbilities.SMITE.get().getId(),                  AMAffinities.LIFE.get(),      Range.ofBounds(0.01, 1))  .build(consumer);
        ...
        createAbility(AMAbilities.MANA_REDUCTION.get().getId(),         AMAffinities.ARCANE.get(),    Range.ofBounds(0.01, 1))  .build(consumer);

...
class AMEnglishLanguageProvider extends AMLanguageProvider {
    ...
    protected void addTranslations() {
        ...
        skillTranslation(AMSpellParts.CONTINGENCY_DAMAGE.getId(), "Contingency: Damage", "Hurting me? That would be bad...", "shapes", "You have managed to create a spell that triggers only when you get hurt. $(br) Let's play shot for shot. $(br) You can only have one contingency active at a time.");
        skillTranslation(AMSpellParts.CONTINGENCY_DEATH.getId(), "Contingency: Death", "You're coming with me.", "shapes", "You may get me, but in those few seconds it takes you, I will have all the time I need to ensure you come along for the ride. $(br) You can only have one contingency active at a time.");
        skillTranslation(AMSpellParts.CONTINGENCY_FALL.getId(), "Contingency: Fall", "Falling... Well at least now it has a purpose.", "shapes", "You have figured out a spell shape that triggers when falling the instant before you hit the ground. $(br) Oh gravity, thou art a heartless... $(br) You can only have one contingency active at a time.");
        ...
        skillTranslation(AMSpellParts.CONTINGENCY_HEALTH.getId(), "Contingency: Health", "I'm not going down... Not right now.", "shapes", "No matter how subtle the wizard, a knife between the shoulder blades will seriously cramp his style. You think you have found a way to make them regret trying that. Or need two knives. $(br) This contingency procs when your health is less than or equal to 25% of maximum. $(br) You can only have one contingency active at a time.");

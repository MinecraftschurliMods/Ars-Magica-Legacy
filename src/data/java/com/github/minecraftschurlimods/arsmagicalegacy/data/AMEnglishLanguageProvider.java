...
class AMEnglishLanguageProvider extends AMLanguageProvider {
    ...
    protected void addTranslations() {
        ...
        add(AffinityCommand.GET, "Affinity depth of %s for player %s is %f");
        add(AffinityCommand.SET_MULTIPLE, "Set affinity depth of %s for %s players to %f");
        add(AffinityCommand.SET_SINGLE, "Set affinity depth of %s for player %s to %f");
        add(AffinityCommand.RESET_MULTIPLE, "Reset all affinity depths for %s players");
        add(AffinityCommand.RESET_SINGLE, "Reset all affinity depths for player %s");
        add(AffinityCommand.UNKNOWN, "Could not find affinity %s");
        add(MagicXPCommand.ADD_LEVELS_MULTIPLE, "Gave %s magic xp levels to %s players");
        add(MagicXPCommand.ADD_LEVELS_SINGLE, "Gave %s magic xp levels to %s");
        add(MagicXPCommand.ADD_POINTS_MULTIPLE, "Gave %s magic xp to %s players");
        add(MagicXPCommand.ADD_POINTS_SINGLE, "Gave %s magic xp to %s");
        add(MagicXPCommand.GET_LEVELS, "%s has %s magic xp levels");
        add(MagicXPCommand.GET_POINTS, "%s has %s magic xp points");
        add(MagicXPCommand.SET_LEVELS_MULTIPLE, "Set %s magic xp levels on %s players");
        add(MagicXPCommand.SET_LEVELS_SINGLE, "Set %s magic xp levels on %s");
        add(MagicXPCommand.SET_POINTS_MULTIPLE, "Set %s magic xp on %s players");
        add(MagicXPCommand.SET_POINTS_SINGLE, "Set %s magic xp on %s");
        add(SkillCommand.ALREADY_KNOWN, "Skill %s has already been learned");
        add(SkillCommand.FORGET_ALL_MULTIPLE, "Took all skill knowledge from %s players");
        add(SkillCommand.FORGET_ALL_SINGLE, "Took all skill knowledge from player %s");
        add(SkillCommand.FORGET_MULTIPLE, "Took knowledge of skill %s from %s players");
        add(SkillCommand.FORGET_SINGLE, "Took knowledge of skill %s from player %s");
        add(SkillCommand.LEARN_ALL_MULTIPLE, "Gave all skill knowledge to %s players");
        add(SkillCommand.LEARN_ALL_SINGLE, "Gave all skill knowledge to player %s");
        add(SkillCommand.LEARN_MULTIPLE, "Gave knowledge of skill %s to %s players");
        add(SkillCommand.LEARN_SINGLE, "Gave knowledge of skill %s to player %s");
        add(SkillCommand.NOT_YET_KNOWN, "Skill %s must be learned first");
        add(SkillCommand.UNKNOWN, "Could not find skill %s");

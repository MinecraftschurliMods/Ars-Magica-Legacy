...
import com.github.minecraftschurlimods.arsmagicalegacy.server.commands.ArsMagicaLegacyCommandTranslations;
...
class AMEnglishLanguageProvider extends AMLanguageProvider {
    ...
    protected void addTranslations() {
        ...
        add(ArsMagicaLegacyCommandTranslations.AFFINITY_GET, "Affinity depth of %s for player %s is %f");
        add(ArsMagicaLegacyCommandTranslations.AFFINITY_RESET_MULTIPLE, "Reset all affinity depths for %s players");
        add(ArsMagicaLegacyCommandTranslations.AFFINITY_RESET_SINGLE, "Reset all affinity depths for player %s");
        add(ArsMagicaLegacyCommandTranslations.AFFINITY_SET_MULTIPLE, "Set affinity depth of %s for %s players to %f");
        add(ArsMagicaLegacyCommandTranslations.AFFINITY_SET_SINGLE, "Set affinity depth of %s for player %s to %f");
        add(ArsMagicaLegacyCommandTranslations.AFFINITY_UNKNOWN, "Could not find affinity %s");
        add(ArsMagicaLegacyCommandTranslations.MAGIC_XP_ADD_LEVELS_MULTIPLE, "Gave %s magic xp levels to %s players");
        add(ArsMagicaLegacyCommandTranslations.MAGIC_XP_ADD_LEVELS_SINGLE, "Gave %s magic xp levels to %s");
        add(ArsMagicaLegacyCommandTranslations.MAGIC_XP_ADD_POINTS_MULTIPLE, "Gave %s magic xp to %s players");
        add(ArsMagicaLegacyCommandTranslations.MAGIC_XP_ADD_POINTS_SINGLE, "Gave %s magic xp to %s");
        add(ArsMagicaLegacyCommandTranslations.MAGIC_XP_GET_LEVELS, "%s has %s magic xp levels");
        add(ArsMagicaLegacyCommandTranslations.MAGIC_XP_GET_POINTS, "%s has %s magic xp points");
        add(ArsMagicaLegacyCommandTranslations.MAGIC_XP_SET_LEVELS_MULTIPLE, "Set %s magic xp levels on %s players");
        add(ArsMagicaLegacyCommandTranslations.MAGIC_XP_SET_LEVELS_SINGLE, "Set %s magic xp levels on %s");
        add(ArsMagicaLegacyCommandTranslations.MAGIC_XP_SET_POINTS_MULTIPLE, "Set %s magic xp on %s players");
        add(ArsMagicaLegacyCommandTranslations.MAGIC_XP_SET_POINTS_SINGLE, "Set %s magic xp on %s");
        add(ArsMagicaLegacyCommandTranslations.RESET_MULTIPLE, "Reset all magic properties for %s players");
        add(ArsMagicaLegacyCommandTranslations.RESET_SINGLE, "Reset all magic properties for player %s");
        add(ArsMagicaLegacyCommandTranslations.SKILL_ALREADY_KNOWN, "Skill %s has already been learned");
        add(ArsMagicaLegacyCommandTranslations.SKILL_FORGET_ALL_MULTIPLE, "Took all skill knowledge from %s players");
        add(ArsMagicaLegacyCommandTranslations.SKILL_FORGET_ALL_SINGLE, "Took all skill knowledge from player %s");
        add(ArsMagicaLegacyCommandTranslations.SKILL_FORGET_MULTIPLE, "Took knowledge of skill %s from %s players");
        add(ArsMagicaLegacyCommandTranslations.SKILL_FORGET_SINGLE, "Took knowledge of skill %s from player %s");
        add(ArsMagicaLegacyCommandTranslations.SKILL_LEARN_ALL_MULTIPLE, "Gave all skill knowledge to %s players");
        add(ArsMagicaLegacyCommandTranslations.SKILL_LEARN_ALL_SINGLE, "Gave all skill knowledge to player %s");
        add(ArsMagicaLegacyCommandTranslations.SKILL_LEARN_MULTIPLE, "Gave knowledge of skill %s to %s players");
        add(ArsMagicaLegacyCommandTranslations.SKILL_LEARN_SINGLE, "Gave knowledge of skill %s to player %s");
        add(ArsMagicaLegacyCommandTranslations.SKILL_NOT_YET_KNOWN, "Skill %s must be learned first");
        add(ArsMagicaLegacyCommandTranslations.SKILL_POINT_ADD_MULTIPLE, "Added %s skill points of type %s to %s players");
        add(ArsMagicaLegacyCommandTranslations.SKILL_POINT_ADD_SINGLE, "Added %s skill points of type %s to player %s");
        add(ArsMagicaLegacyCommandTranslations.SKILL_POINT_CONSUME_MULTIPLE, "Consumed %s skill points of type %s from %s players");
        add(ArsMagicaLegacyCommandTranslations.SKILL_POINT_CONSUME_SINGLE, "Consumed %s skill points of type %s from player %s");
        add(ArsMagicaLegacyCommandTranslations.SKILL_POINT_GET, "Player %s has %d skill points of type %s");
        add(ArsMagicaLegacyCommandTranslations.SKILL_POINT_SET_MULTIPLE, "%s players now have %d skill points of type %s");
        add(ArsMagicaLegacyCommandTranslations.SKILL_POINT_SET_SINGLE, "Player %s now has %d skill points of type %s");
        add(ArsMagicaLegacyCommandTranslations.SKILL_POINT_UNKNOWN, "Could not find skill point type %s");
        add(ArsMagicaLegacyCommandTranslations.SKILL_UNKNOWN, "Could not find skill %s");

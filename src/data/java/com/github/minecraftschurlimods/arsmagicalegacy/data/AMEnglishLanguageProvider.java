...
class AMEnglishLanguageProvider extends AMLanguageProvider {
    ...
    protected void addTranslations() {
        ...
        skillTranslation(AMSpellParts.DISMEMBERING.getId(), "Dismembering", "Wasn't me. I swear he had no head when I came in.", "modifiers", "You like souvenirs so much that you have discovered how to make your damaging spells leave some pieces intact.$(br2)Each modifier adds a 5%% chance to drop a head when defeating an enemy.");
        ...
        skillTranslation(AMSpellParts.SUMMON.getId(), "Summon", "Rise, creation!", "components", "You have learned to harvest and recreate the souls of other lifeforms.$(br)First, shift-use the spell on a weakened entity (no more than five health points) to take it as a template. Note that this will absorb the template's soul, killing it in the process. Particularly strong enemies (bosses) cannot be absorbed.");
        ...
        skillTranslation(AMSpellParts.TELEKINESIS.getId(), "Telekinesis", "Up, down, up, down, I think you get the idea.", "components", "You can use your magic to amplify your brainwaves, giving them physical form. These waves can be used to pull entities towards a point in front of you.$(br2)Rolling the mouse wheel while using the spell can change the distance of the point closer or farther away from you.");
        ...
        configTranslation("spell_parts.forge_smelts_villagers", "Whether the Forge component instantly kills villagers, dropping emeralds.");
        configTranslation("spell_parts.summon.base_count", "The maximum amount of summons a player can have.");
        configTranslation("spell_parts.summon.extra_count", "The amount of possible summons the Extra Summons talent adds.");
        configTranslation("spell_parts.summon.mana_multiplier", "When summoning a minion, the mana consumed will be this value times the summoned minion's max health.");

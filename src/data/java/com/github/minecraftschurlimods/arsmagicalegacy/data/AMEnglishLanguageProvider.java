...
class AMEnglishLanguageProvider extends AMLanguageProvider {
    ...
    protected void addTranslations() {
        ...
        add(ArsMagicaLegacyCommand.AFFINITY_GET, "Affinity depth of %s for player %s is %f");
        add(ArsMagicaLegacyCommand.AFFINITY_RESET_MULTIPLE, "Reset all affinity depths for %s players");
        add(ArsMagicaLegacyCommand.AFFINITY_RESET_SINGLE, "Reset all affinity depths for player %s");
        add(ArsMagicaLegacyCommand.AFFINITY_SET_MULTIPLE, "Set affinity depth of %s for %s players to %f");
        add(ArsMagicaLegacyCommand.AFFINITY_SET_SINGLE, "Set affinity depth of %s for player %s to %f");
        add(ArsMagicaLegacyCommand.AFFINITY_UNKNOWN, "Could not find affinity %s");
        add(ArsMagicaLegacyCommand.MAGIC_XP_ADD_LEVELS_MULTIPLE, "Gave %s magic xp levels to %s players");
        add(ArsMagicaLegacyCommand.MAGIC_XP_ADD_LEVELS_SINGLE, "Gave %s magic xp levels to %s");
        add(ArsMagicaLegacyCommand.MAGIC_XP_ADD_POINTS_MULTIPLE, "Gave %s magic xp to %s players");
        add(ArsMagicaLegacyCommand.MAGIC_XP_ADD_POINTS_SINGLE, "Gave %s magic xp to %s");
        add(ArsMagicaLegacyCommand.MAGIC_XP_GET_LEVELS, "%s has %s magic xp levels");
        add(ArsMagicaLegacyCommand.MAGIC_XP_GET_POINTS, "%s has %s magic xp points");
        add(ArsMagicaLegacyCommand.MAGIC_XP_SET_LEVELS_MULTIPLE, "Set %s magic xp levels on %s players");
        add(ArsMagicaLegacyCommand.MAGIC_XP_SET_LEVELS_SINGLE, "Set %s magic xp levels on %s");
        add(ArsMagicaLegacyCommand.MAGIC_XP_SET_POINTS_MULTIPLE, "Set %s magic xp on %s players");
        add(ArsMagicaLegacyCommand.MAGIC_XP_SET_POINTS_SINGLE, "Set %s magic xp on %s");
        add(ArsMagicaLegacyCommand.RESET_MULTIPLE, "Reset all magic properties for %s players");
        add(ArsMagicaLegacyCommand.RESET_SINGLE, "Reset all magic properties for player %s");
        add(ArsMagicaLegacyCommand.SKILL_ALREADY_KNOWN, "Skill %s has already been learned");
        add(ArsMagicaLegacyCommand.SKILL_FORGET_ALL_MULTIPLE, "Took all skill knowledge from %s players");
        add(ArsMagicaLegacyCommand.SKILL_FORGET_ALL_SINGLE, "Took all skill knowledge from player %s");
        add(ArsMagicaLegacyCommand.SKILL_FORGET_MULTIPLE, "Took knowledge of skill %s from %s players");
        add(ArsMagicaLegacyCommand.SKILL_FORGET_SINGLE, "Took knowledge of skill %s from player %s");
        add(ArsMagicaLegacyCommand.SKILL_LEARN_ALL_MULTIPLE, "Gave all skill knowledge to %s players");
        add(ArsMagicaLegacyCommand.SKILL_LEARN_ALL_SINGLE, "Gave all skill knowledge to player %s");
        add(ArsMagicaLegacyCommand.SKILL_LEARN_MULTIPLE, "Gave knowledge of skill %s to %s players");
        add(ArsMagicaLegacyCommand.SKILL_LEARN_SINGLE, "Gave knowledge of skill %s to player %s");
        add(ArsMagicaLegacyCommand.SKILL_NOT_YET_KNOWN, "Skill %s must be learned first");
        add(ArsMagicaLegacyCommand.SKILL_POINT_ADD_MULTIPLE, "Added %s skill points of type %s to %s players");
        add(ArsMagicaLegacyCommand.SKILL_POINT_ADD_SINGLE, "Added %s skill points of type %s to player %s");
        add(ArsMagicaLegacyCommand.SKILL_POINT_CONSUME_MULTIPLE, "Consumed %s skill points of type %s from %s players");
        add(ArsMagicaLegacyCommand.SKILL_POINT_CONSUME_SINGLE, "Consumed %s skill points of type %s from player %s");
        add(ArsMagicaLegacyCommand.SKILL_POINT_GET, "Player %s has %d skill points of type %s");
        add(ArsMagicaLegacyCommand.SKILL_POINT_SET_MULTIPLE, "%s players now have %d skill points of type %s");
        add(ArsMagicaLegacyCommand.SKILL_POINT_SET_SINGLE, "Player %s now has %d skill points of type %s");
        add(ArsMagicaLegacyCommand.SKILL_POINT_UNKNOWN, "Could not find skill point type %s");
        add(ArsMagicaLegacyCommand.SKILL_UNKNOWN, "Could not find skill %s");

...
class AMEnglishLanguageProvider extends AMLanguageProvider {
    ...
    protected void addTranslations() {
        ...
        skillTranslation(AMSpellParts.CHAIN.getId(), "[WIP] Chain", "Looks like you brought friends. Well, I don't mind, you're all gonna die.", "shapes", "You can shape your magic into a blast that jumps from one target to the next. Chain contains an 8-block built in touch-like components, though you can, if you like, add $(l:shapes/projectile)Projectile$() to start the chain somewhere else.$(br2)A chain spell cannot affect the caster. Chain jump range can be extended by using the $(l:modifiers/range)Range$() modifier.");
        ...
        skillTranslation(AMSpellParts.KNOCKBACK.getId(), "Knockback", "Punch from a distance!", "components", "As a mage, you most likely don't want to be in melee range. This components allows that situation to be corrected.");
        ...
        skillTranslation(AMSpellParts.LIGHT.getId(), "Light", "The end of a tunnel.", "components", "You can light up an area with magic.$(br2)If you apply this components onto a living being, it will light up the darkness by itself.");
        ...
        skillTranslation(AMSpellParts.MINING_POWER.getId(), "Mining Power", "Who needs diamond?", "modifiers", "You have learned to put more power into your digging spells. This causes them to be able to dig more dense blocks that would require a better tool.$(br2)Each modifier bumps the spell up by one tool level.$(br2)The base $(l:components/dig)dig$() components operates at iron mining level.");
        ...
        skillTranslation(AMSpellParts.STORM.getId(), "Storm", "It's raining...", "components", "The cloud darken, and rain begins to fall. The wind howls, and a flash of lightning strikes across the sky, leaving bright flashes in your vision.$(br2)This components changes the weather to a thunderstorm.");

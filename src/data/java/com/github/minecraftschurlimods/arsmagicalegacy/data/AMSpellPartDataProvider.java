...
class AMSpellPartDataProvider extends SpellPartDataProvider {
    AMSpellPartDataProvider(PackOutput output, CompletableFuture<HolderLookup.Provider> registries) {
    ...
    protected void generate() {
        ...
        builder(AMSpellParts.CHAIN, 1f)
                .addIngredient(new IngredientSpellIngredient(Ingredient.of(AMTags.Items.GEMS_TOPAZ), 1))
                .addIngredient(new IngredientSpellIngredient(Ingredient.of(AMItems.AUM.get()), 1))
                .addIngredient(new IngredientSpellIngredient(Ingredient.of(Tags.Items.STRINGS), 1))
        ...
        builder(AMSpellParts.CONTINGENCY_DAMAGE, 10f)
                .addIngredient(new IngredientSpellIngredient(DataComponentIngredient.of(true, helper.getEssenceForAffinity(AMAffinities.LIGHTNING)), 1))
        ...
        builder(AMSpellParts.CONTINGENCY_DEATH, 10f)
                .addIngredient(new IngredientSpellIngredient(DataComponentIngredient.of(true, helper.getEssenceForAffinity(AMAffinities.ENDER)), 1))
                .addIngredient(new IngredientSpellIngredient(Ingredient.of(AMTags.Items.GEMS_TOPAZ), 1))
                .addIngredient(new IngredientSpellIngredient(Ingredient.of(Items.CLOCK), 1))
                .addIngredient(new IngredientSpellIngredient(Ingredient.of(AMItems.TARMA_ROOT.get()), 1))
        ...
        builder(AMSpellParts.CONTINGENCY_FALL, 10f)
                .addIngredient(new IngredientSpellIngredient(DataComponentIngredient.of(true, helper.getEssenceForAffinity(AMAffinities.AIR)), 1))
                .addIngredient(new IngredientSpellIngredient(Ingredient.of(AMTags.Items.DUSTS_VINTEUM), 1))
                .addIngredient(new IngredientSpellIngredient(Ingredient.of(Items.CLOCK), 1))
                .addIngredient(new IngredientSpellIngredient(Ingredient.of(AMItems.TARMA_ROOT.get()), 1))
                .addIngredient(new EtheriumSpellIngredient(EtheriumType.ANY, 5000))
        ...
        builder(AMSpellParts.CONTINGENCY_FIRE, 10f)
                .addIngredient(new IngredientSpellIngredient(DataComponentIngredient.of(true, helper.getEssenceForAffinity(AMAffinities.FIRE)), 1))
        ...
        builder(AMSpellParts.CONTINGENCY_HEALTH, 10f)
                .addIngredient(new IngredientSpellIngredient(DataComponentIngredient.of(true, helper.getEssenceForAffinity(AMAffinities.LIFE)), 1))
        ...
        builder(AMSpellParts.FIRE_DAMAGE, 25f)
                ...
                .addIngredient(new IngredientSpellIngredient(Ingredient.of(AMItems.COLORED_RUNE.get(DyeColor.RED)), 1))
                .addIngredient(new IngredientSpellIngredient(Ingredient.of(AMTags.Items.DUSTS_VINTEUM), 1))
                .addIngredient(new IngredientSpellIngredient(DataComponentIngredient.of(true, new ItemStack(Items.FLINT_AND_STEEL)), 1))
                .build();
        ...
        builder(AMSpellParts.ABSORPTION, 50f)
                ...
                .addIngredient(new IngredientSpellIngredient(DataComponentIngredient.of(true, new ItemStack(Items.SHIELD)), 1))
                .build();
        builder(AMSpellParts.BLINDNESS, 40f)
                .addAffinity(AMAffinities.ENDER, 0.001f)
                .addIngredient(new IngredientSpellIngredient(Ingredient.of(AMItems.COLORED_RUNE.get(DyeColor.BLACK)), 1))
                .addIngredient(new IngredientSpellIngredient(DataComponentIngredient.of(true, DataComponents.POTION_CONTENTS, new PotionContents(Potions.NIGHT_VISION), Items.POTION), 1))
                .addIngredient(new IngredientSpellIngredient(DataComponentIngredient.of(true, DataComponents.POTION_CONTENTS, new PotionContents(Potions.WEAKNESS), Items.POTION), 1))
                .build();
        ...
        builder(AMSpellParts.INVISIBILITY, 40f)
                ...
                .addIngredient(new IngredientSpellIngredient(Ingredient.of(AMItems.COLORED_RUNE.get(DyeColor.WHITE)), 1))
                .addIngredient(new IngredientSpellIngredient(Ingredient.of(AMTags.Items.GEMS_CHIMERITE), 1))
                .addIngredient(new IngredientSpellIngredient(DataComponentIngredient.of(true, DataComponents.POTION_CONTENTS, new PotionContents(Potions.INVISIBILITY), Items.POTION), 1))
                .build();
        ...
        builder(AMSpellParts.GRAVITY_WELL, 40f)
                ...
                .addIngredient(new IngredientSpellIngredient(Ingredient.of(Tags.Items.STONES), 1))
                .build();
        builder(AMSpellParts.REFLECT, 50f)
                ...
                .addIngredient(new IngredientSpellIngredient(Ingredient.of(Tags.Items.RODS_BLAZE), 1))
                .addIngredient(new IngredientSpellIngredient(Ingredient.of(Tags.Items.GLASS_BLOCKS), 1))
        ...
        builder(AMSpellParts.SWIFT_SWIM, 40f)
                ...
                .addIngredient(new IngredientSpellIngredient(DataComponentIngredient.of(true, new ItemStack(Items.FISHING_ROD)), 1))
                .build();
        ...
        builder(AMSpellParts.WATERY_GRAVE, 40f)
                ...
                .addIngredient(new IngredientSpellIngredient(Ingredient.of(AMItems.COLORED_RUNE.get(DyeColor.BLUE)), 1))
                .addIngredient(new IngredientSpellIngredient(Ingredient.of(Tags.Items.STONES), 1))
                .addIngredient(new IngredientSpellIngredient(DataComponentIngredient.of(true, new ItemStack(Items.LEATHER_BOOTS)), 1))
                .build();
        ...
        builder(AMSpellParts.BLIZZARD, 1000f)
                ...
                .addIngredient(new IngredientSpellIngredient(DataComponentIngredient.of(true, helper.getEssenceForAffinity(AMAffinities.ICE)), 1))
                .addIngredient(new IngredientSpellIngredient(Ingredient.of(AMTags.Items.GEMS_TOPAZ), 1))
                .addIngredient(new IngredientSpellIngredient(Ingredient.of(Items.ICE), 1))
        ...
        builder(AMSpellParts.DIG, 5f)
                .addAffinity(AMAffinities.EARTH, 0.001f)
                .addIngredient(new IngredientSpellIngredient(Ingredient.of(AMItems.COLORED_RUNE.get(DyeColor.BROWN)), 1))
                .addIngredient(new IngredientSpellIngredient(DataComponentIngredient.of(true, new ItemStack(Items.IRON_AXE)), 1))
                .addIngredient(new IngredientSpellIngredient(DataComponentIngredient.of(true, new ItemStack(Items.IRON_PICKAXE)), 1))
                .addIngredient(new IngredientSpellIngredient(DataComponentIngredient.of(true, new ItemStack(Items.IRON_SHOVEL)), 1))
                .build();
        builder(AMSpellParts.DISARM, 60f)
                .addAffinity(AMAffinities.ARCANE, 0.002f)
                .addIngredient(new IngredientSpellIngredient(Ingredient.of(AMItems.COLORED_RUNE.get(DyeColor.PURPLE)), 1))
                .addIngredient(new IngredientSpellIngredient(DataComponentIngredient.of(true, new ItemStack(Items.IRON_SWORD)), 1))
                .build();
        ...
        builder(AMSpellParts.FALLING_STAR, 1000f)
                ...
                .addIngredient(new IngredientSpellIngredient(DataComponentIngredient.of(true, helper.getEssenceForAffinity(AMAffinities.ARCANE)), 1))
        ...
        builder(AMSpellParts.FIRE_RAIN, 1000f)
                ...
                .addIngredient(new IngredientSpellIngredient(DataComponentIngredient.of(true, helper.getEssenceForAffinity(AMAffinities.FIRE)), 1))
                .addIngredient(new IngredientSpellIngredient(Ingredient.of(AMTags.Items.DUSTS_ARCANE_ASH), 1))
                .addIngredient(new IngredientSpellIngredient(Ingredient.of(Tags.Items.NETHERRACKS), 1))
                .addIngredient(new IngredientSpellIngredient(Ingredient.of(Items.LAVA_BUCKET), 1))
                .build();
        ...
        builder(AMSpellParts.HARVEST, 5f)
                .addAffinity(AMAffinities.NATURE, 0.001f)
                .addIngredient(new IngredientSpellIngredient(Ingredient.of(AMItems.COLORED_RUNE.get(DyeColor.GREEN)), 1))
                .addIngredient(new IngredientSpellIngredient(DataComponentIngredient.of(true, new ItemStack(Items.SHEARS)), 1))
                .build();
        ...
        builder(AMSpellParts.PLOW, 5f)
                .addAffinity(AMAffinities.EARTH, 0.001f)
                .addIngredient(new IngredientSpellIngredient(Ingredient.of(AMItems.COLORED_RUNE.get(DyeColor.GREEN)), 1))
                .addIngredient(new IngredientSpellIngredient(DataComponentIngredient.of(true, new ItemStack(Items.IRON_HOE)), 1))
                .build();
        ...
        builder(AMSpellParts.BOUNCE, 1.25f)
                .addIngredient(new IngredientSpellIngredient(DataComponentIngredient.of(true, helper.getEssenceForAffinity(AMAffinities.WATER)), 1))
                .addIngredient(new IngredientSpellIngredient(Ingredient.of(Tags.Items.SLIMEBALLS), 1))
                .build();
        builder(AMSpellParts.DAMAGE, 1.25f)
                .addIngredient(new IngredientSpellIngredient(DataComponentIngredient.of(true, helper.getEssenceForAffinity(AMAffinities.FIRE)), 1))
                .addIngredient(new IngredientSpellIngredient(Ingredient.of(Items.COPPER_INGOT), 1))
                .addIngredient(new IngredientSpellIngredient(DataComponentIngredient.of(true, DataComponents.POTION_CONTENTS, new PotionContents(Potions.HARMING), Items.POTION), 1))
                .build();
        ...
        builder(AMSpellParts.EFFECT_POWER, 1.25f)
                ...
                .addIngredient(new IngredientSpellIngredient(Ingredient.of(Tags.Items.DUSTS_GLOWSTONE), 1))
                .addIngredient(new IngredientSpellIngredient(Ingredient.of(Tags.Items.DUSTS_REDSTONE), 1))
                .addIngredient(new IngredientSpellIngredient(Ingredient.of(Tags.Items.GUNPOWDERS), 1))
                .addIngredient(new IngredientSpellIngredient(Ingredient.of(Items.GLASS_BOTTLE), 1))
                .addIngredient(new IngredientSpellIngredient(Ingredient.of(Items.SPIDER_EYE), 1))
                .build();
        builder(AMSpellParts.GRAVITY, 1.25f)
                .addIngredient(new IngredientSpellIngredient(DataComponentIngredient.of(true, helper.getEssenceForAffinity(AMAffinities.EARTH)), 1))
        ...
        builder(AMSpellParts.HEALING, 1.25f)
                ...
                .addIngredient(new IngredientSpellIngredient(DataComponentIngredient.of(true, DataComponents.POTION_CONTENTS, new PotionContents(Potions.HEALING), Items.POTION), 1))
                .build();
        builder(AMSpellParts.LUNAR, 1f)
                .addIngredient(new IngredientSpellIngredient(DataComponentIngredient.of(true, helper.getEssenceForAffinity(AMAffinities.NATURE)), 1))
                .addIngredient(new IngredientSpellIngredient(Ingredient.of(AMTags.Items.GEMS_MOONSTONE), 1))
                .addIngredient(new IngredientSpellIngredient(Ingredient.of(Items.CLOCK), 1))
                .build();
        ...
        builder(AMSpellParts.TARGET_NON_SOLID, 1.25f)
                ...
                .addIngredient(new IngredientSpellIngredient(DataComponentIngredient.of(true, DataComponents.POTION_CONTENTS, new PotionContents(Potions.WATER), Items.POTION), 1))
                .build();
        builder(AMSpellParts.VELOCITY, 1.25f)
                .addIngredient(new IngredientSpellIngredient(DataComponentIngredient.of(true, helper.getEssenceForAffinity(AMAffinities.LIGHTNING)), 1))
                .addIngredient(new IngredientSpellIngredient(Ingredient.of(Tags.Items.FEATHERS), 1))
                .addIngredient(new IngredientSpellIngredient(Ingredient.of(ItemTags.BOATS), 1))
                .addIngredient(new IngredientSpellIngredient(DataComponentIngredient.of(true, DataComponents.POTION_CONTENTS, new PotionContents(Potions.SWIFTNESS), Items.POTION), 1))
                .build();

...
class AMSpellPartDataProvider extends SpellPartDataProvider {
    ...
    protected void createSpellPartData() {
        ...
        createSpellPartData(AMSpellParts.AOE, 2f)
                ...
                .withIngredient(new EtheriumSpellIngredient(EnumSet.of(EtheriumType.LIGHT, EtheriumType.NEUTRAL, EtheriumType.DARK), 1))
                .build();
        createSpellPartData(AMSpellParts.BEAM, 1f)
                ...
                .withIngredient(new EtheriumSpellIngredient(EnumSet.of(EtheriumType.LIGHT), 2500))
                .build();
        ...
        createSpellPartData(AMSpellParts.CONTINGENCY_DAMAGE, 10f)
                ...
                .withIngredient(new EtheriumSpellIngredient(EnumSet.of(EtheriumType.LIGHT, EtheriumType.NEUTRAL, EtheriumType.DARK), 5000))
                .build();
        createSpellPartData(AMSpellParts.CONTINGENCY_DEATH, 10f)
                ...
                .withIngredient(new IngredientSpellIngredient(Ingredient.of(Items.CLOCK), 1))
                .withIngredient(new IngredientSpellIngredient(Ingredient.of(AMItems.TARMA_ROOT.get()), 1))
                .withIngredient(new EtheriumSpellIngredient(EnumSet.of(EtheriumType.DARK), 5000))
                .build();
        ...
        createSpellPartData(AMSpellParts.CONTINGENCY_HEALTH, 10f)
                ...
                .withIngredient(new IngredientSpellIngredient(Ingredient.of(Items.CLOCK), 1))
                .withIngredient(new IngredientSpellIngredient(Ingredient.of(AMItems.TARMA_ROOT.get()), 1))
                .withIngredient(new EtheriumSpellIngredient(EnumSet.of(EtheriumType.LIGHT), 5000))
                .build();
        ...
        createSpellPartData(AMSpellParts.WALL, 2.5f)
                ...
                .withIngredient(new EtheriumSpellIngredient(EnumSet.of(EtheriumType.LIGHT, EtheriumType.NEUTRAL, EtheriumType.DARK), 2500))
                .build();
        ...
        createSpellPartData(AMSpellParts.FIRE_DAMAGE, 25f)
                ...
                .withIngredient(new IngredientSpellIngredient(Ingredient.of(AMItems.COLORED_RUNE.get(DyeColor.RED)), 1))
                .withIngredient(new IngredientSpellIngredient(Ingredient.of(AMTags.Items.DUSTS_VINTEUM), 1))
                .withIngredient(new IngredientSpellIngredient(StrictNBTIngredient.of(new ItemStack(Items.FLINT_AND_STEEL)), 1))
                .build();
        ...
        createSpellPartData(AMSpellParts.ABSORPTION, 50f)
                ...
                .withIngredient(new IngredientSpellIngredient(StrictNBTIngredient.of(new ItemStack(Items.SHIELD)), 1))
                .build();
        createSpellPartData(AMSpellParts.BLINDNESS, 40f)
                .withAffinity(AMAffinities.ENDER, 0.001f)
                .withIngredient(new IngredientSpellIngredient(Ingredient.of(AMItems.COLORED_RUNE.get(DyeColor.BLACK)), 1))
                .withIngredient(new IngredientSpellIngredient(StrictNBTIngredient.of(PotionUtils.setPotion(new ItemStack(Items.POTION), Potions.NIGHT_VISION)), 1))
                .withIngredient(new IngredientSpellIngredient(StrictNBTIngredient.of(PotionUtils.setPotion(new ItemStack(Items.POTION), Potions.WEAKNESS)), 1))
                .build();
        ...
        createSpellPartData(AMSpellParts.INVISIBILITY, 40f)
                ...
                .withIngredient(new IngredientSpellIngredient(Ingredient.of(AMItems.COLORED_RUNE.get(DyeColor.WHITE)), 1))
                .withIngredient(new IngredientSpellIngredient(Ingredient.of(AMTags.Items.GEMS_CHIMERITE), 1))
                .withIngredient(new IngredientSpellIngredient(StrictNBTIngredient.of(PotionUtils.setPotion(new ItemStack(Items.POTION), Potions.INVISIBILITY)), 1))
                .build();
        ...
        createSpellPartData(AMSpellParts.SWIFT_SWIM, 40f)
                ...
                .withIngredient(new IngredientSpellIngredient(StrictNBTIngredient.of(new ItemStack(Items.FISHING_ROD)), 1))
                .build();
        ...
        createSpellPartData(AMSpellParts.WATERY_GRAVE, 40f)
                ...
                .withIngredient(new IngredientSpellIngredient(Ingredient.of(AMItems.COLORED_RUNE.get(DyeColor.BLUE)), 1))
                .withIngredient(new IngredientSpellIngredient(Ingredient.of(Tags.Items.STONE), 1))
                .withIngredient(new IngredientSpellIngredient(StrictNBTIngredient.of(new ItemStack(Items.LEATHER_BOOTS)), 1))
                .build();
        ...
        createSpellPartData(AMSpellParts.DIG, 5f)
                .withAffinity(AMAffinities.EARTH, 0.001f)
                .withIngredient(new IngredientSpellIngredient(Ingredient.of(AMItems.COLORED_RUNE.get(DyeColor.BROWN)), 1))
                .withIngredient(new IngredientSpellIngredient(StrictNBTIngredient.of(new ItemStack(Items.IRON_AXE)), 1))
                .withIngredient(new IngredientSpellIngredient(StrictNBTIngredient.of(new ItemStack(Items.IRON_PICKAXE)), 1))
                .withIngredient(new IngredientSpellIngredient(StrictNBTIngredient.of(new ItemStack(Items.IRON_SHOVEL)), 1))
                .build();
        createSpellPartData(AMSpellParts.DISARM, 60f)
                .withAffinity(AMAffinities.ARCANE, 0.002f)
                .withIngredient(new IngredientSpellIngredient(Ingredient.of(AMItems.COLORED_RUNE.get(DyeColor.PURPLE)), 1))
                .withIngredient(new IngredientSpellIngredient(StrictNBTIngredient.of(new ItemStack(Items.IRON_SWORD)), 1))
                .build();
        ...
        createSpellPartData(AMSpellParts.HARVEST, 5f)
                .withAffinity(AMAffinities.NATURE, 0.001f)
                .withIngredient(new IngredientSpellIngredient(Ingredient.of(AMItems.COLORED_RUNE.get(DyeColor.GREEN)), 1))
                .withIngredient(new IngredientSpellIngredient(StrictNBTIngredient.of(new ItemStack(Items.SHEARS)), 1))
                .build();
        ...
        createSpellPartData(AMSpellParts.PLOW, 5f)
                .withAffinity(AMAffinities.EARTH, 0.001f)
                .withIngredient(new IngredientSpellIngredient(Ingredient.of(AMItems.COLORED_RUNE.get(DyeColor.GREEN)), 1))
                .withIngredient(new IngredientSpellIngredient(StrictNBTIngredient.of(new ItemStack(Items.IRON_HOE)), 1))
                .build();
        ...
        createSpellPartData(AMSpellParts.SUMMON, 80f)
                ...
                .withIngredient(new IngredientSpellIngredient(Ingredient.of(AMTags.Items.DUSTS_PURIFIED_VINTEUM), 1))
                .withIngredient(new IngredientSpellIngredient(Ingredient.of(AMItems.CERUBLOSSOM.get()), 1))
                .withIngredient(new EtheriumSpellIngredient(EnumSet.of(EtheriumType.DARK), 2500))
                .build();
        ...
        createSpellPartData(AMSpellParts.DAMAGE, 1.25f)
                .withIngredient(new IngredientSpellIngredient(StrictNBTIngredient.of(helper.getStackForAffinity(AMItems.AFFINITY_ESSENCE.get(), AMAffinities.FIRE.get())), 1))
                .withIngredient(new IngredientSpellIngredient(Ingredient.of(Items.COPPER_INGOT), 1))
                .withIngredient(new IngredientSpellIngredient(StrictNBTIngredient.of(PotionUtils.setPotion(new ItemStack(Items.POTION), Potions.HARMING)), 1))
                .build();
        ...
        createSpellPartData(AMSpellParts.LUNAR, 1f)
                .withIngredient(new IngredientSpellIngredient(StrictNBTIngredient.of(helper.getStackForAffinity(AMItems.AFFINITY_ESSENCE.get(), AMAffinities.NATURE.get())), 1))
                .withIngredient(new IngredientSpellIngredient(Ingredient.of(AMTags.Items.GEMS_MOONSTONE), 1))
                .withIngredient(new IngredientSpellIngredient(Ingredient.of(Items.CLOCK), 1))
                .build();
        createSpellPartData(AMSpellParts.MINING_POWER, 1.25f)
                .withIngredient(new IngredientSpellIngredient(StrictNBTIngredient.of(helper.getStackForAffinity(AMItems.AFFINITY_ESSENCE.get(), AMAffinities.EARTH.get())), 1))
        ...
        createSpellPartData(AMSpellParts.VELOCITY, 1.25f)
                ...
                .withIngredient(new IngredientSpellIngredient(StrictNBTIngredient.of(PotionUtils.setPotion(new ItemStack(Items.POTION), Potions.SWIFTNESS)), 1))
                .build();
    }
}

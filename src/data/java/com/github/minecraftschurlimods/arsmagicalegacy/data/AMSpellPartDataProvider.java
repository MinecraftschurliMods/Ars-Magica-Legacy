...
class AMSpellPartDataProvider extends SpellPartDataProvider {
    ...
    protected void createSpellPartData() {
        ...
        createSpellPartData(AMSpellParts.ZONE, 3.5f)
                ...
                .withIngredient(new IngredientSpellIngredient(Ingredient.of(AMItems.TARMA_ROOT.get()), 1))
                .build();
        createSpellPartData(AMSpellParts.DROWNING_DAMAGE, 40f)
                ...
                .build();
        createSpellPartData(AMSpellParts.FIRE_DAMAGE, 40f)
                ...
                .build();
        createSpellPartData(AMSpellParts.FROST_DAMAGE, 40f)
                ...
                .build();
        createSpellPartData(AMSpellParts.LIGHTNING_DAMAGE, 60f)
                ...
                .build();
        createSpellPartData(AMSpellParts.MAGIC_DAMAGE, 40f)

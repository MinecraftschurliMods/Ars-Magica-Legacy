...
public class AMWorldgenProvider extends WorldgenProvider {
    ...
    protected void generateBiomeModifiers() {
        ...
        bm("moonstone_meteoreite", new ForgeBiomeModifiers.AddFeaturesBiomeModifier(and(bt(BiomeTags.IS_OVERWORLD), bt(BiomeTags.IS_OCEAN)), HolderSet.direct(pf("moonstone_meteoreite")), GenerationStep.Decoration.LOCAL_MODIFICATIONS));

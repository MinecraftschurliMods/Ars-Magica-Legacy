...
class AMWorldgenProvider extends WorldgenProvider {
    ...
    protected void generateBiomeModifiers() {
        ...
        bm("moonstone_meteorite", new ForgeBiomeModifiers.AddFeaturesBiomeModifier(and(bt(BiomeTags.IS_OVERWORLD), not(bt(BiomeTags.IS_OCEAN))), HolderSet.direct(pf("moonstone_meteorite")), GenerationStep.Decoration.LOCAL_MODIFICATIONS));

...
class AMCompatDataProvider extends CompatDataProvider {
    protected AMCompatDataProvider(GatherDataEvent event) {
    ...
    protected void generate() {
        ...
        CREATE_CRUSHING.add(CREATE_CRUSHING.builder("sunstone_ore", 500)
                .addInput(Ingredient.of(AMItems.SUNSTONE_ORE.get()))
                .addOutput(AMItems.SUNSTONE.get())
                .addOutput(AMItems.SUNSTONE.get(), 0.75f)
                .addOutput(new ResourceLocation("create", "powdered_obsidian"), 0.125f));

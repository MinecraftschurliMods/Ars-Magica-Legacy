...
class AMPrefabSpellProvider extends PrefabSpellProvider {
    AMPrefabSpellProvider(DataGenerator generator, ExistingFileHelper existingFileHelper, LanguageProvider languageProvider) {
        super(ArsMagicaAPI.MOD_ID, generator, existingFileHelper, languageProvider);
    }

...
class AMPrefabSpellProvider extends PrefabSpellProvider {
    ...
    protected void createPrefabSpells() {
        ...
        addPrefabSpell("dispel", "Dispel", new ResourceLocation(ArsMagicaAPI.MOD_ID, "beam_royal_3"), api.makeSpell(
        ...
        addPrefabSpell("arcane_bolt", "Arcane Bolt", new ResourceLocation(ArsMagicaAPI.MOD_ID, "beam_magenta_3"), api.makeSpell(
            SpellStack.of(AMSpellParts.MAGIC_DAMAGE.get(), AMSpellParts.DAMAGE.get()),
            ShapeGroup.of(AMSpellParts.PROJECTILE.get())
        ));
        ...
        addPrefabSpell("blink", "Blink", new ResourceLocation(ArsMagicaAPI.MOD_ID, "shield_magenta_3"), api.makeSpell(
            SpellStack.of(AMSpellParts.BLINK.get()),
            ShapeGroup.of(AMSpellParts.SELF.get())
        ));
        addPrefabSpell("heal_self", "Heal Self", new ResourceLocation(ArsMagicaAPI.MOD_ID, "shield_royal_3"), api.makeSpell(
        ...
        addPrefabSpell("area_lightning", "Area Lightning", new ResourceLocation(ArsMagicaAPI.MOD_ID, "lightning_sky_3"), api.makeSpell(
                SpellStack.of(AMSpellParts.LIGHTNING_DAMAGE.get(), AMSpellParts.DAMAGE.get()),
                ShapeGroup.of(AMSpellParts.PROJECTILE.get(), AMSpellParts.AOE.get())
        ));
        addPrefabSpell("scramble_synapses", "Scramble Synapses", new ResourceLocation(ArsMagicaAPI.MOD_ID, "slice_acid_3"), api.makeSpell(
        ...
        addPrefabSpell("nausea", "Nausea", new ResourceLocation(ArsMagicaAPI.MOD_ID, "sword_jade_3"), api.makeSpell(

...
class AMPatchouliBookProvider extends PatchouliBookProvider {
    ...
    protected void addBooks(Consumer<BookBuilder<?, ?, ?>> consumer) {
        ...
        builder.addCategory("blocks", "Blocks", "", new ItemStack(AMItems.OCCULUS.get()))
                ...
                .addSpotlightPage(new ItemStack(AMItems.AUM.get())).setText("A flower with healing properties, Aum is a components in many spells. It can be found in forests.").setAnchor("aum").build()
                ...
                .addSpotlightPage(new ItemStack(AMItems.WAKEBLOOM.get())).setText("Growing on the surface of water in warm climates, Wakebloom is used in water-based spells frequently, as well as being a components in water affinity essences.").setAnchor("wakebloom").build()

...
class AMPatchouliBookProvider extends PatchouliBookProvider {
    ...
    protected void addBooks(HolderLookup.Provider provider, Consumer<BookBuilder<?, ?, ?>> consumer) {
        ...
        builder.addCategory("blocks", "Blocks", "", new ItemStack(AMItems.OCCULUS.get()))
                ...
                .addSimpleSpotlightPage(new ItemStack(AMItems.BLACK_AUREM.get()), "The Black Aurem cannot be obtained through crafting. Instead, it must be created through a special corruption ritual. This ritual requires a multiblock structure, seen on the next page. To initiate the ritual, you must $(l:components/fire_damage)severely burn$() the Obelisk.")
                .addSimpleMultiblockPage("Corruption Ritual", "Make sure you're close to the Obelisk when initiating the ritual!", PatchouliCompat.CORRUPTION_RITUAL)
                ...
                .addSimpleSpotlightPage(new ItemStack(AMItems.CELESTIAL_PRISM.get()), "The Celestial Prism cannot be obtained through crafting. Instead, it must be created through a special purification ritual. This ritual requires a multiblock structure, seen on the next page. To initiate the ritual, simply place some $(l:components/light)light$() on the Obelisk.")
                .addSimpleMultiblockPage("Purification Ritual", "Make sure you're close to the Obelisk when initiating the ritual!", PatchouliCompat.PURIFICATION_RITUAL)

...
class AMPatchouliBookProvider extends PatchouliBookProvider {
    ...
    protected void addBooks(Consumer<BookBuilder<?, ?, ?>> consumer) {
        ...
        builder.addCategory("entities", "Entities", "", new ItemStack(AMItems.MANA_CREEPER_SPAWN_EGG.get()))
                ...
                .addSimpleTextPage("This boss is a work in progress. But when it is done, be ready for a fight!")
                .addSimpleMultiblockPage("Spawn Ritual", PatchouliCompat.WATER_GUARDIAN_SPAWN_RITUAL)
                .build()
                .addEntry("fire_guardian", "Fire Guardian", api.getAffinityHelper().getEssenceForAffinity(AMAffinities.FIRE.get()))
                .addSimpleTextPage("This boss is a work in progress. But when it is done, be ready for a fight!")
                .addSimpleMultiblockPage("Spawn Ritual", PatchouliCompat.FIRE_GUARDIAN_SPAWN_RITUAL)
                .build()
                .addEntry("earth_guardian", "Earth Guardian", api.getAffinityHelper().getEssenceForAffinity(AMAffinities.EARTH.get()))
                .addSimpleTextPage("This boss is a work in progress. But when it is done, be ready for a fight!")
                .addSimpleMultiblockPage("Spawn Ritual", PatchouliCompat.EARTH_GUARDIAN_SPAWN_RITUAL)
                .build()
                .addEntry("air_guardian", "Air Guardian", api.getAffinityHelper().getEssenceForAffinity(AMAffinities.AIR.get()))
                .addSimpleTextPage("This boss is a work in progress. But when it is done, be ready for a fight!")
                .addSimpleMultiblockPage("Spawn Ritual", PatchouliCompat.AIR_GUARDIAN_SPAWN_RITUAL)
                .build()
                .addEntry("ice_guardian", "Ice Guardian", api.getAffinityHelper().getEssenceForAffinity(AMAffinities.ICE.get()))
                .addSimpleTextPage("This boss is a work in progress. But when it is done, be ready for a fight!")
                .addSimpleMultiblockPage("Spawn Ritual", PatchouliCompat.ICE_GUARDIAN_SPAWN_RITUAL)
                .build()
                .addEntry("lightning_guardian", "Lightning Guardian", api.getAffinityHelper().getEssenceForAffinity(AMAffinities.LIGHTNING.get()))
                .addSimpleTextPage("This boss is a work in progress. But when it is done, be ready for a fight!")
                .addSimpleMultiblockPage("Spawn Ritual", PatchouliCompat.LIGHTNING_GUARDIAN_SPAWN_RITUAL)
                .build()
                .addEntry("nature_guardian", "Nature Guardian", api.getAffinityHelper().getEssenceForAffinity(AMAffinities.NATURE.get()))
                .addSimpleTextPage("This boss is a work in progress. But when it is done, be ready for a fight!")
                .addSimpleTextPage("Unlike all other bosses, this boss intervenes when too many dryads are slain in a row.", "Spawn Ritual")
                .build()
                .addEntry("life_guardian", "Life Guardian", api.getAffinityHelper().getEssenceForAffinity(AMAffinities.LIFE.get()))
                .addSimpleTextPage("This boss is a work in progress. But when it is done, be ready for a fight!")
                .addSimpleMultiblockPage("Spawn Ritual", PatchouliCompat.LIFE_GUARDIAN_SPAWN_RITUAL)
                .build()
                .addEntry("arcane_guardian", "Arcane Guardian", api.getAffinityHelper().getEssenceForAffinity(AMAffinities.ARCANE.get()))
                .addSimpleTextPage("This boss is a work in progress. But when it is done, be ready for a fight!")
                .addSimpleMultiblockPage("Spawn Ritual", PatchouliCompat.ARCANE_GUARDIAN_SPAWN_RITUAL)
                .build()
                .addEntry("ender_guardian", "Ender Guardian", api.getAffinityHelper().getEssenceForAffinity(AMAffinities.ENDER.get()))
                .addSimpleTextPage("This boss is a work in progress. But when it is done, be ready for a fight!")
                .addSimpleMultiblockPage("Spawn Ritual", PatchouliCompat.ENDER_GUARDIAN_SPAWN_RITUAL)
                .build()
                .build();

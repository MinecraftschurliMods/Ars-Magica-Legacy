...
class AMSkillProvider extends SkillProvider {
    ...
    protected void createSkills(Consumer<SkillBuilder> consumer) {
        ...
        SkillBuilder.create(WATER_BREATHING.getId(), UTILITY).setPosition(410, 345).addCost(AMSkillPoints.BLUE.getId())/*.addParent(DROUGHT.getId())*/.build(consumer); // TODO
        ...
        SkillBuilder.create(RANGE.getId(), UTILITY).setPosition(140, 345).addCost(AMSkillPoints.RED.getId())/*.addParent(RANDOM_TELEPORT.getId())*/.build(consumer); // TODO
    }
}

...
public final class AMPatchouliBookProvider extends PatchouliBookProvider {
    ...
    protected void addBooks(HolderLookup.Provider lookupProvider, Consumer<BookBuilder<?, ?, ?>> consumer) {
        ...
        TranslatedBookBuilder builder = createBookBuilder("arcane_compendium", "Arcane Compendium", "A renewed look into Minecraft with a splash of magic...", translationConsumer, lookupProvider)
            ...
            .setVersion("1");
        builder.addCategory("mechanics", "Mechanics", "", new ItemStackTemplate(AMItems.ALTAR_CORE.get()))
            .setSortnum(0)
            ...
            .build()
            .addEntry("crafting_altar", "Crafting Altar", new ItemStackTemplate(AMItems.ALTAR_CORE.get()))
            ...
            .addSimpleSpotlightPage(new ItemStackTemplate(AMItems.ALTAR_CORE.get()), "A basic yet important block, it focuses an altar's power in order to perform spell crafting.")
            .addSimpleSpotlightPage(new ItemStackTemplate(AMItems.MAGIC_WALL.get()), "The magic wall was a nice try into illusion blocks, but it did not work. Instead, it has proven important when building crafting altars.")
            ...
            .addSimpleTextPage("Each altar is defined by two groups of blocks, the cap material and the structure material. Both hold a certain power, the sum of which defines the total amount of distinct ingredients a spell recipe crafted at the altar can have.$(br2)The available materials can be found in your recipe viewer.")
            .build()
            .addEntry("etherium", "Etherium", new ItemStackTemplate(AMItems.CRYSTAL_WRENCH.get()))
            ...
            .build()
            .addEntry("liquid_etherium", "Liquid Etherium", new ItemStackTemplate(AMItems.LIQUID_ETHERIUM_BUCKET.get()))
            ...
            .addSimpleSpotlightPage(new ItemStackTemplate(AMItems.LIQUID_ETHERIUM_BUCKET.get()), "Liquid Etherium can be processed in an $(l:blocks/obelisk)Obelisk$() to create neutral $(l:mechanics/etherium)Etherium$(). One bucket of Liquid Etherium is worth 1000 Etherium (or 10 units of $(l:blocks/ores#vinteum)vinteum$()).")
            .addSimpleTextPage("Bathing in Liquid Etherium grants the Mana Regeneration effect.$(br2)And as you should know by now, placing a book in a nearby item frame yields a copy of the very book you are reading this in.")
            .build()
            .addEntry("shape_groups", "Shape Groups", new ItemStackTemplate(AMItems.INSCRIPTION_TABLE_UPGRADE_TIER_1.get()))
            ...
            .build()
            .addEntry("silver_spell_parts", "Silver Spell Parts", new ItemStackTemplate(AMItems.MOONSTONE.get()))
            ...
            .build()
            .build();
        builder.addCategory("blocks", "Blocks", "", new ItemStackTemplate(AMItems.OCCULUS.get()))
            .setSortnum(1)
            .addEntry("black_aurem", "Black Aurem", new ItemStackTemplate(AMItems.BLACK_AUREM.get()))
            ...
            .build()
            .addEntry("celestial_prism", "Celestial Prism", new ItemStackTemplate(AMItems.CELESTIAL_PRISM.get()))
            ...
            .addSpotlightPage(new ItemStackTemplate(AMItems.TARMA_ROOT.get())).setText("Lighter than it looks, Tarma Root grows in mountain biomes. It is an ingredient in spells and air essences.").setAnchor("tarma_root").build()
            .addSpotlightPage(new ItemStackTemplate(AMItems.WAKEBLOOM.get())).setText("Growing on the surface of water in warm climates, Wakebloom is used in water-based spells frequently, as well as being a component in water affinity essences.").setAnchor("wakebloom").build()
            ...
            .build()
            .addEntry("inlays", "Inlays", new ItemStackTemplate(AMItems.IRON_INLAY.get()))
            /* TODO inlays
            ...
            */
            ...
            .build()
            .addEntry("inscription_table", "Inscription Table", new ItemStackTemplate(AMItems.INSCRIPTION_TABLE.get()))
            ...
            .build()
            .addEntry("obelisk", "Obelisk", new ItemStackTemplate(AMItems.OBELISK.get()))
            ...
            .build()
            .addEntry("occulus", "Occulus", new ItemStackTemplate(AMItems.OCCULUS.get()))
            ...
            .build()
            .addEntry("ores", "Ores", new ItemStackTemplate(AMItems.CHIMERITE_ORE.get()))
            .addSimpleTextPage("A variety of ores can be found scattered across the world.")
            .addSpotlightPage(new ItemStackTemplate(AMItems.CHIMERITE_ORE.get())).setText("Found where the stones shift, Chimerite is used in spells that require a great deal of alternation or illusion.").setAnchor("chimerite").build()
            .addSpotlightPage(new ItemStackTemplate(AMItems.TOPAZ_ORE.get())).setText("Found in the deepest depths or on the highest peaks, Topaz is commonly used as an entry level magical crystal.").setAnchor("topaz").build()
            .addSpotlightPage(new ItemStackTemplate(AMItems.VINTEUM_ORE.get())).setText("Found relatively common in most layers of the world, Vinteum Dust quickly proved itself a viable magical resource.").setAnchor("vinteum").build()
            .addSpotlightPage(new ItemStackTemplate(AMItems.MOONSTONE_ORE.get())).setText("Rarely found in meteorites that crashed upon the world a long time ago, Moonstone is a celestial material with extraordinary magical powers.").setAnchor("moonstone").build()
            .addSpotlightPage(new ItemStackTemplate(AMItems.SUNSTONE_ORE.get())).setText("Sunstone gems were formed over thousands of years inside patches of obsidian touching the nether's lava oceans. Despite this, they are not fire-resistant, and great care must be taken to obtain them.").setAnchor("sunstone").build()
            ...
            .build()
            .addEntry("vinteum_torch", "Vinteum Torch", new ItemStackTemplate(AMItems.VINTEUM_TORCH.get()))
            ...
            .build()
            .addEntry("witchwood", "Witchwood", new ItemStackTemplate(AMItems.WITCHWOOD_LOG.get()))
            ...
            .build()
            .addEntry("wizards_chalk", "Wizard's Chalk", new ItemStackTemplate(AMItems.WIZARDS_CHALK.get()))
            ...
            .build()
            .build();
        builder.addCategory("items", "Items", "", new ItemStackTemplate(AMItems.PURIFIED_VINTEUM_DUST.get()))
            .setSortnum(2)
            ...
            .build()
            .addEntry("arcane_ash", "Arcane Ash", new ItemStackTemplate(AMItems.ARCANE_ASH.get()))
            ...
            .build()
            .addEntry("arcane_compound", "Arcane Compound", new ItemStackTemplate(AMItems.ARCANE_COMPOUND.get()))
            ...
            .build()
            .addEntry("mage_armor", "Mage Armor", new ItemStackTemplate(AMItems.MAGE_HELMET.get()))
            ...
            .build()
            .addEntry("magitech_goggles", "Magitech Goggles", new ItemStackTemplate(AMItems.MAGITECH_GOGGLES.get()))
            ...
            .build()
            .addEntry("mana_food", "Mana Food", new ItemStackTemplate(AMItems.MANA_CAKE.get()))
            ...
            .build()
            .addEntry("purified_vinteum_dust", "Purified Vinteum Dust", new ItemStackTemplate(AMItems.PURIFIED_VINTEUM_DUST.get()))
            ...
            .build()
            .addEntry("rune_bag", "Rune Bag", new ItemStackTemplate(AMItems.RUNE_BAG.get()))
            ...
            .build()
            .addEntry("runes", "Runes", new ItemStackTemplate(AMItems.BLANK_RUNE.get()))
            ...
            .build()
            .addEntry("spell_book", "Spell Book", new ItemStackTemplate(AMItems.SPELL_BOOK.get()))
            ...
            .build()
            .addEntry("spell_parchment", "Spell Parchment", new ItemStackTemplate(AMItems.SPELL_PARCHMENT.get()))
            ...
            .build()
            .build();
        builder.addCategory("entities", "Entities", "", new ItemStackTemplate(AMItems.MANA_CREEPER_SPAWN_EGG.get()))
            .setSortnum(3)
            .addEntry("mana_creeper", "Mana Creeper", new ItemStackTemplate(AMItems.MANA_CREEPER_SPAWN_EGG.get()))
            ...
            .build()
            .addEntry("fire_guardian", "Fire Guardian", new ItemStackTemplate(AMItems.FIRE_GUARDIAN_SPAWN_EGG.get()))
            ...
            .build()
            .addEntry("earth_guardian", "Earth Guardian", new ItemStackTemplate(AMItems.EARTH_GUARDIAN_SPAWN_EGG.get()))
            ...
            .build()
            .addEntry("air_guardian", "Air Guardian", new ItemStackTemplate(AMItems.AIR_GUARDIAN_SPAWN_EGG.get()))
            ...
            .build()
            .addEntry("ice_guardian", "Ice Guardian", new ItemStackTemplate(AMItems.ICE_GUARDIAN_SPAWN_EGG.get()))
            ...
            .build()
            .addEntry("lightning_guardian", "Lightning Guardian", new ItemStackTemplate(AMItems.LIGHTNING_GUARDIAN_SPAWN_EGG.get()))
            ...
            .build()
            .addEntry("nature_guardian", "Nature Guardian", new ItemStackTemplate(AMItems.NATURE_GUARDIAN_SPAWN_EGG.get()))
            ...
            .build()
            .addEntry("life_guardian", "Life Guardian", new ItemStackTemplate(AMItems.LIFE_GUARDIAN_SPAWN_EGG.get()))
            ...
            .build()
            .addEntry("arcane_guardian", "Arcane Guardian", new ItemStackTemplate(AMItems.ARCANE_GUARDIAN_SPAWN_EGG.get()))
            ...
            .build()
            .addEntry("ender_guardian", "Ender Guardian", new ItemStackTemplate(AMItems.ENDER_GUARDIAN_SPAWN_EGG.get()))

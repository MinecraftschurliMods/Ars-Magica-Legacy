...
public final class AMLanguageProvider extends LanguageProvider {
    ...
    protected void addTranslations() {
        ...
        add(AMTags.Blocks.BLACK_AUREM_PILLAR, "Black Aurem Multiblock Pillars");
        add(AMTags.Blocks.BLACK_AUREM_CATALYST_1, "Black Aurem Multiblock Catalyst Level 1");
        add(AMTags.Blocks.BLACK_AUREM_CATALYST_2, "Black Aurem Multiblock Catalyst Level 2");
        add(AMTags.Blocks.BLACK_AUREM_CATALYST_3, "Black Aurem Multiblock Catalyst Level 3");
        add(AMTags.Blocks.BLACK_AUREM_CATALYST_4, "Black Aurem Multiblock Catalyst Level 4");
        add(AMTags.Blocks.CELESTIAL_PRISM_PILLAR, "Celestial Prism Multiblock Pillars");
        add(AMTags.Blocks.CELESTIAL_PRISM_CATALYST_1, "Celestial Prism Multiblock Catalyst Level 1");
        add(AMTags.Blocks.CELESTIAL_PRISM_CATALYST_2, "Celestial Prism Multiblock Catalyst Level 2");
        add(AMTags.Blocks.CELESTIAL_PRISM_CATALYST_3, "Celestial Prism Multiblock Catalyst Level 3");
        add(AMTags.Blocks.CELESTIAL_PRISM_CATALYST_4, "Celestial Prism Multiblock Catalyst Level 4");
        ...
        add(AMTags.Blocks.CHALKS, "Chalks");

...
public interface AMTags {
    ...
    interface Blocks {
        ...
        TagKey<Block> BLACK_AUREM_PILLAR = tag("black_aurem/pillar");
        TagKey<Block> BLACK_AUREM_CATALYST_1 = tag("black_aurem/catalyst_1");
        TagKey<Block> BLACK_AUREM_CATALYST_2 = tag("black_aurem/catalyst_2");
        TagKey<Block> BLACK_AUREM_CATALYST_3 = tag("black_aurem/catalyst_3");
        TagKey<Block> BLACK_AUREM_CATALYST_4 = tag("black_aurem/catalyst_4");
        TagKey<Block> CELESTIAL_PRISM_PILLAR = tag("celestial_prism/pillar");
        TagKey<Block> CELESTIAL_PRISM_CATALYST_1 = tag("celestial_prism/catalyst_1");
        TagKey<Block> CELESTIAL_PRISM_CATALYST_2 = tag("celestial_prism/catalyst_2");
        TagKey<Block> CELESTIAL_PRISM_CATALYST_3 = tag("celestial_prism/catalyst_3");
        TagKey<Block> CELESTIAL_PRISM_CATALYST_4 = tag("celestial_prism/catalyst_4");
        ...
        TagKey<Block> CHALKS = tag("chalks");

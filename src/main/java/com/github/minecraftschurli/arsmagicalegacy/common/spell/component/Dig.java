...
public class Dig extends AbstractComponent {
    ...
    public SpellCastResult invoke(ISpell spell, LivingEntity caster, Level level, List<ISpellModifier> modifiers, BlockHitResult target, int index, int ticksUsed) {
        ...
        if (caster instanceof Player player) {
            ...
            ItemStack dummyStack = createDummyStack(spellHelper.countModifiers(modifiers, AMSpellParts.FORTUNE.getId()),
                                                    spellHelper.countModifiers(modifiers, AMSpellParts.SILK_TOUCH.getId()));

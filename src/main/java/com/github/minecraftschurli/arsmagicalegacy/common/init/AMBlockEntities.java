...
public interface AMBlockEntities {
    ...
    RegistryObject<BlockEntityType<InscriptionTableBlockEntity>> INSCRIPTION_TABLE = BLOCK_ENTITIES.register("inscription_table", () -> new BlockEntityType<>(InscriptionTableBlockEntity::new, Set.of(AMBlocks.INSCRIPTION_TABLE.get()), null));

...
import com.github.minecraftschurli.arsmagicalegacy.common.spell.shape.Beam;
import com.github.minecraftschurli.arsmagicalegacy.common.spell.shape.Chain;
import com.github.minecraftschurli.arsmagicalegacy.common.spell.shape.Channel;
...
public interface AMSpellParts {
    ...
    RegistryObject<Effect>             SLOW_FALLING        = SPELL_PARTS.register("slow_falling",        () -> new Effect(MobEffects.SLOW_FALLING, 600));
    RegistryObject<Effect>             WATER_BREATHING     = SPELL_PARTS.register("water_breathing",     () -> new Effect(MobEffects.WATER_BREATHING, 600));
    RegistryObject<Effect>             AGILITY             = SPELL_PARTS.register("agility",             () -> new Effect(AMMobEffects.AGILITY, 600));
    ...
    RegistryObject<Freeze>             FREEZE              = SPELL_PARTS.register("freeze",              Freeze::new);

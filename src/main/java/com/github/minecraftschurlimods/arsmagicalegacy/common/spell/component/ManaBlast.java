...
public class ManaBlast extends AbstractComponent {
    ...
    public SpellCastResult invoke(ISpell spell, LivingEntity caster, Level level, List<ISpellModifier> modifiers, EntityHitResult target, int index, int ticksUsed) {
        ...
        living.hurt(level.damageSources().indirectMagic(caster, null), api.getSpellHelper().getModifiedStat((float) (mana / Config.SERVER.MANA_MULTIPLIER.get()), SpellPartStats.DAMAGE, modifiers, spell, caster, target));

...
public interface AMItems {
    ...
    RegistryObject<Item>                         ETHERIUM_PLACEHOLDER             = ITEMS.register("etherium_placeholder", () -> new Item(ITEM_1));
    ...
    RegistryObject<MageArmorItem>                MAGE_HELMET                      = ITEMS.register("mage_helmet", () -> new MageArmorItem(MageArmorItem.MAGE_ARMOR_MATERIAL, ArmorItem.Type.HELMET, 5));
    RegistryObject<MageArmorItem>                MAGE_CHESTPLATE                  = ITEMS.register("mage_chestplate", () -> new MageArmorItem(MageArmorItem.MAGE_ARMOR_MATERIAL, ArmorItem.Type.CHESTPLATE, 5));
    RegistryObject<MageArmorItem>                MAGE_LEGGINGS                    = ITEMS.register("mage_leggings", () -> new MageArmorItem(MageArmorItem.MAGE_ARMOR_MATERIAL, ArmorItem.Type.LEGGINGS, 5));
    RegistryObject<MageArmorItem>                MAGE_BOOTS                       = ITEMS.register("mage_boots", () -> new MageArmorItem(MageArmorItem.MAGE_ARMOR_MATERIAL, ArmorItem.Type.BOOTS, 5));
    RegistryObject<MageArmorItem>                BATTLEMAGE_HELMET                = ITEMS.register("battlemage_helmet", () -> new MageArmorItem(MageArmorItem.BATTLEMAGE_ARMOR_MATERIAL, ArmorItem.Type.HELMET, 10));
    RegistryObject<MageArmorItem>                BATTLEMAGE_CHESTPLATE            = ITEMS.register("battlemage_chestplate", () -> new MageArmorItem(MageArmorItem.BATTLEMAGE_ARMOR_MATERIAL, ArmorItem.Type.CHESTPLATE, 10));
    RegistryObject<MageArmorItem>                BATTLEMAGE_LEGGINGS              = ITEMS.register("battlemage_leggings", () -> new MageArmorItem(MageArmorItem.BATTLEMAGE_ARMOR_MATERIAL, ArmorItem.Type.LEGGINGS, 10));
    RegistryObject<MageArmorItem>                BATTLEMAGE_BOOTS                 = ITEMS.register("battlemage_boots", () -> new MageArmorItem(MageArmorItem.BATTLEMAGE_ARMOR_MATERIAL, ArmorItem.Type.BOOTS, 10));

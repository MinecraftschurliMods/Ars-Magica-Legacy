...
public interface AMSpellParts {
    ...
    RegistryObject<Damage>             DROWNING_DAMAGE     = SPELL_PARTS.register("drowning_damage",     () -> new Damage(e -> e.damageSources().drown(), Config.SERVER.DAMAGE, LivingEntity::canBreatheUnderwater));

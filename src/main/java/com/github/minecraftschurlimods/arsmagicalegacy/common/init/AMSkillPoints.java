...
public interface AMSkillPoints {
    RegistryObject<ISkillPoint> NONE  = AMRegistries.SKILL_POINTS.register("none",  () -> new SkillPoint(0x7f7f7f, 0,  1));
    RegistryObject<ISkillPoint> BLUE  = AMRegistries.SKILL_POINTS.register("blue",  () -> new SkillPoint(0x0000ff, -1, -1));

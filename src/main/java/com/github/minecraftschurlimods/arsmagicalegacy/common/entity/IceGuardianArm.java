...
// TODO
public class IceGuardianArm extends Entity {
    public IceGuardianArm(EntityType<? extends IceGuardianArm> type, Level level) {
        super(type, level);
    }
     ...
     */
    public static IceGuardianArm create(Level level) {
        return new IceGuardianArm(AMEntities.ICE_GUARDIAN_ARM.get(), level);
    }

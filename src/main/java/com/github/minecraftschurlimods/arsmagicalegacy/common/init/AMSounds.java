...
public interface AMSounds {
    ...
    RegistryObject<SoundEvent> ICE_GUARDIAN_ATTACK              = register("entity.ice_guardian.attack");
    RegistryObject<SoundEvent> ICE_GUARDIAN_DEATH               = register("entity.ice_guardian.death");
    RegistryObject<SoundEvent> ICE_GUARDIAN_HURT                = register("entity.ice_guardian.hurt");

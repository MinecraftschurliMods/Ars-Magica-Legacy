...
public class Ignition extends AbstractComponent {
    ...
    public SpellCastResult invoke(ISpell spell, LivingEntity caster, Level level, List<ISpellModifier> modifiers, EntityHitResult target, int index, int ticksUsed) {
        ...
        target.getEntity().setRemainingFireTicks((int) ArsMagicaAPI.get().getSpellHelper().getModifiedStat(3, SpellPartStats.DURATION, modifiers, spell, caster, target, index) * 20);
        return SpellCastResult.SUCCESS;
    }

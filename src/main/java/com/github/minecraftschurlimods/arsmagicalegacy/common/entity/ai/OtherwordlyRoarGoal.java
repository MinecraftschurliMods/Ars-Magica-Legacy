...
public class OtherwordlyRoarGoal extends Goal {
    ...
    public OtherwordlyRoarGoal(EnderGuardian enderGuardian) {
        ...
        spell = enderGuardian.level.registryAccess().registryOrThrow(PrefabSpell.REGISTRY_KEY).get(new ResourceLocation(ArsMagicaAPI.MOD_ID, "otherworldly_roar")).spell();
    }

...
public interface AMEntities {
    ...
    RegistryObject<EntityType<FallingStar>>       FALLING_STAR       = ENTITIES.register("falling_star",       () -> EntityType.Builder.of(FallingStar::new,       MobCategory.MISC)   .clientTrackingRange(8).sized(0.25F, 0.25F).build("falling_star"));

...
public interface AMBlocks {
    ...
    RegistryObject<DoorBlock>               WITCHWOOD_DOOR              = BLOCKS.register("witchwood_door",              () -> new DoorBlock(BlockBehaviour.Properties.of(Material.WOOD, AMBlocks.WITCHWOOD_PLANKS.get().defaultMaterialColor()).strength(3.0F).sound(SoundType.WOOD).noOcclusion(), AMWoodTypes.WITCHWOOD_BLOCK_SET_TYPE));
    RegistryObject<TrapDoorBlock>           WITCHWOOD_TRAPDOOR          = BLOCKS.register("witchwood_trapdoor",          () -> new TrapDoorBlock(BlockBehaviour.Properties.of(Material.WOOD, AMBlocks.WITCHWOOD_PLANKS.get().defaultMaterialColor()).strength(3.0F).sound(SoundType.WOOD).noOcclusion().isValidSpawn(AMBlocks::never), AMWoodTypes.WITCHWOOD_BLOCK_SET_TYPE));
    RegistryObject<ButtonBlock>             WITCHWOOD_BUTTON            = BLOCKS.register("witchwood_button",            () -> new ButtonBlock(BlockBehaviour.Properties.of(Material.DECORATION).noCollission().strength(0.5F).sound(SoundType.WOOD), AMWoodTypes.WITCHWOOD_BLOCK_SET_TYPE, 30, true));
    RegistryObject<PressurePlateBlock>      WITCHWOOD_PRESSURE_PLATE    = BLOCKS.register("witchwood_pressure_plate",    () -> new PressurePlateBlock(PressurePlateBlock.Sensitivity.EVERYTHING, BlockBehaviour.Properties.of(Material.WOOD, AMBlocks.WITCHWOOD_PLANKS.get().defaultMaterialColor()).noCollission().strength(0.5F).sound(SoundType.WOOD), AMWoodTypes.WITCHWOOD_BLOCK_SET_TYPE));

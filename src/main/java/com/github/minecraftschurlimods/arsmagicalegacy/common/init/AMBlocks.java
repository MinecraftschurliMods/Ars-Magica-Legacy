...
public interface AMBlocks {
    ...
    RegistryObject<SlabBlock>               WITCHWOOD_SLAB              = BLOCKS.register("witchwood_slab",              () -> new SlabBlock(BlockBehaviour.Properties.of(Material.WOOD, AMBlocks.WITCHWOOD_PLANKS.get().defaultMaterialColor()).strength(2.0F, 3.0F).sound(SoundType.WOOD)));
    ...
    RegistryObject<FenceBlock>              WITCHWOOD_FENCE             = BLOCKS.register("witchwood_fence",             () -> new FenceBlock(BlockBehaviour.Properties.of(Material.WOOD, AMBlocks.WITCHWOOD_PLANKS.get().defaultMaterialColor()).strength(2.0F, 3.0F).sound(SoundType.WOOD)));
    RegistryObject<FenceGateBlock>          WITCHWOOD_FENCE_GATE        = BLOCKS.register("witchwood_fence_gate",        () -> new FenceGateBlock(BlockBehaviour.Properties.of(Material.WOOD, AMBlocks.WITCHWOOD_PLANKS.get().defaultMaterialColor()).strength(2.0F, 3.0F).sound(SoundType.WOOD), SoundEvents.FENCE_GATE_CLOSE, SoundEvents.FENCE_GATE_OPEN));
    RegistryObject<DoorBlock>               WITCHWOOD_DOOR              = BLOCKS.register("witchwood_door",              () -> new DoorBlock(BlockBehaviour.Properties.of(Material.WOOD, AMBlocks.WITCHWOOD_PLANKS.get().defaultMaterialColor()).strength(3.0F).sound(SoundType.WOOD).noOcclusion(), SoundEvents.WOODEN_DOOR_CLOSE, SoundEvents.WOODEN_DOOR_OPEN));
    RegistryObject<TrapDoorBlock>           WITCHWOOD_TRAPDOOR          = BLOCKS.register("witchwood_trapdoor",          () -> new TrapDoorBlock(BlockBehaviour.Properties.of(Material.WOOD, AMBlocks.WITCHWOOD_PLANKS.get().defaultMaterialColor()).strength(3.0F).sound(SoundType.WOOD).noOcclusion().isValidSpawn(AMBlocks::never), SoundEvents.WOODEN_TRAPDOOR_CLOSE, SoundEvents.WOODEN_TRAPDOOR_OPEN));
    RegistryObject<ButtonBlock>             WITCHWOOD_BUTTON            = BLOCKS.register("witchwood_button",            () -> new ButtonBlock(BlockBehaviour.Properties.of(Material.DECORATION).noCollission().strength(0.5F).sound(SoundType.WOOD), 30, true, SoundEvents.WOODEN_BUTTON_CLICK_OFF, SoundEvents.WOODEN_BUTTON_CLICK_ON));
    RegistryObject<PressurePlateBlock>      WITCHWOOD_PRESSURE_PLATE    = BLOCKS.register("witchwood_pressure_plate",    () -> new PressurePlateBlock(PressurePlateBlock.Sensitivity.EVERYTHING, BlockBehaviour.Properties.of(Material.WOOD, AMBlocks.WITCHWOOD_PLANKS.get().defaultMaterialColor()).noCollission().strength(0.5F).sound(SoundType.WOOD), SoundEvents.WOODEN_PRESSURE_PLATE_CLICK_OFF, SoundEvents.WOODEN_PRESSURE_PLATE_CLICK_ON));
    ...
    RegistryObject<CeilingHangingSignBlock> WITCHWOOD_HANGING_SIGN      = BLOCKS.register("witchwood_hanging_sign",      () -> new CustomCeilingHangingSignBlock(BlockBehaviour.Properties.of(Material.WOOD, WITCHWOOD_LOG.get().defaultMaterialColor()).noCollission().strength(1.0F).sound(SoundType.HANGING_SIGN).requiredFeatures(FeatureFlags.UPDATE_1_20), AMWoodTypes.WITCHWOOD));
    RegistryObject<WallHangingSignBlock>    WITCHWOOD_WALL_HANGING_SIGN = BLOCKS.register("witchwood_wall_hanging_sign", () -> new CustomWallHangingSignBlock(BlockBehaviour.Properties.of(Material.WOOD, WITCHWOOD_LOG.get().defaultMaterialColor()).noCollission().strength(1.0F).sound(SoundType.HANGING_SIGN).requiredFeatures(FeatureFlags.UPDATE_1_20).lootFrom(WITCHWOOD_HANGING_SIGN), AMWoodTypes.WITCHWOOD));

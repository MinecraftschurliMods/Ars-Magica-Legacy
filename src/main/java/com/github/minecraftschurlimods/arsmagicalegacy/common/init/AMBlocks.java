...
public interface AMBlocks {
    ...
    DeferredBlock<FlowerBlock>             AUM                         = BLOCKS.register("aum",                                () -> new FlowerBlock(AMMobEffects.MANA_REGEN, 7, BlockBehaviour.Properties.ofLegacyCopy(Blocks.POPPY)));
    ...
    DeferredBlock<LiquidBlock>             LIQUID_ESSENCE              = BLOCKS.register("liquid_essence",              () -> new LiquidBlock(AMFluids.LIQUID_ESSENCE.value(), BlockBehaviour.Properties.of().noCollission().strength(100.0F).noLootTable().lightLevel((state) -> 5)));

...
public interface AMBlockEntities {
    ...
    RegistryObject<BlockEntityType<CustomSignBlockEntity>>       WITCHWOOD_SIGN    = BLOCK_ENTITIES.register("witchwood_sign",    () -> BlockEntityType.Builder.of(CustomSignBlockEntity::new, AMBlocks.WITCHWOOD_SIGN.get(), AMBlocks.WITCHWOOD_WALL_SIGN.get()).build(null));

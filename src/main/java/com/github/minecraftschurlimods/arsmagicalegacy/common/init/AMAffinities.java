...
public interface AMAffinities {
    ...
    RegistryObject<IAffinity> ICE       = AMRegistries.AFFINITIES.register("ice",       () -> Affinity.builder().setColor(0xd3e8fc).setDirectOpposite(IAffinity.LIGHTNING).setCastSound(AMSounds.CAST_WINTER)   .setLoopSound(AMSounds.LOOP_WINTER)   .addMajorOpposites(IAffinity.LIFE, IAffinity.FIRE, IAffinity.AIR, IAffinity.ARCANE)        .addMinorOpposites(IAffinity.WATER, IAffinity.ENDER)     .build());

...
public interface AMAffinities {
    RegistryObject<Affinity> NONE      = AFFINITIES.register("none",      () -> Affinity.builder().setColor(0)       .setDirectOpposite(Affinity.NONE)     .setCastSound(AMSounds.CAST_NONE).setParticle(AMParticleTypes.NONE_HAND).build());
    ...
    RegistryObject<Affinity> EARTH     = AFFINITIES.register("earth",     () -> Affinity.builder().setColor(0x61330b).setDirectOpposite(Affinity.AIR)      .setCastSound(AMSounds.CAST_EARTH)    .setLoopSound(AMSounds.LOOP_EARTH)    .addMajorOpposites(Affinity.WATER, Affinity.ARCANE, Affinity.LIFE, Affinity.LIGHTNING) .addMinorOpposites(Affinity.NATURE, Affinity.FIRE)     .setParticle(AMParticleTypes.EARTH_HAND)    .build());
    ...
    RegistryObject<Affinity> LIFE      = AFFINITIES.register("life",      () -> Affinity.builder().setColor(0x34e122).setDirectOpposite(Affinity.ENDER)    .setCastSound(AMSounds.CAST_LIFE)     .setLoopSound(AMSounds.LOOP_LIFE)     .addMajorOpposites(Affinity.ARCANE, Affinity.ICE, Affinity.FIRE, Affinity.EARTH)       .addMinorOpposites(Affinity.NATURE, Affinity.LIGHTNING).setParticle(AMParticleTypes.LIFE_HAND)     .build());

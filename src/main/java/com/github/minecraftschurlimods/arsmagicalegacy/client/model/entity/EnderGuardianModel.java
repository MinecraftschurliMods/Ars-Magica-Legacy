...
public class EnderGuardianModel extends EntityModel<EnderGuardian> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        spine.addOrReplaceChild("ribs", CubeListBuilder.create()
        ...
        spine.addOrReplaceChild("backbone", CubeListBuilder.create()
        ...
        wingbone.addOrReplaceChild("wingbone_upper_right", CubeListBuilder.create()
        ...
        wingbone.addOrReplaceChild("wingbone_upper_left", CubeListBuilder.create()
        ...
        wingbone.addOrReplaceChild("wingbone_lower_right", CubeListBuilder.create()
        ...
        wingbone.addOrReplaceChild("wingbone_lower_left", CubeListBuilder.create()

...
//            poseStack.translate(sprite.getWidth() / 2f, 0, sprite.getWidth() / 2f);
//            Vector3f vec = new Vector3f(rot, 0, 0);
//            Quaternion q = Quaternion.fromXYZDegrees(vec);
//            Matrix4f rotationMatrix = new Matrix4f(q);
            Matrix4f poseMatrix = pose.pose();
//            rotationMatrix.multiply(poseMatrix);
//            poseMatrix = rotationMatrix;
            float scale = 10f;
//            float translate = rot;
            Matrix4f scaleMatrix = Matrix4f.createScaleMatrix(scale, scale, scale);
//            Matrix4f translateMatrix = Matrix4f.createTranslateMatrix(0, 0, translate);
//            scaleMatrix.multiply(q);
            scaleMatrix.multiply(poseMatrix);

...
public class LightningGuardianModel extends EntityModel<LightningGuardian> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        ModelUtil.addCube(pd, "head", 0, 20, -1.5f, -3, -1.5f, 3, 3, 3, 0, 7, 0);
        ModelUtil.addCube(pd, "chest", 0, 26, -3.5f, -2, -2.5f, 7, 4, 5, 0, 9, 0);
        ModelUtil.addMirroredCube(pd, "body", 12, 20, -2, -2, -1, 4, 4, 2, 0, 13, 0);
        ModelUtil.addCube(pd, "tail", 0, 39, -1, -3, -0.5f, 2, 6, 1, 0, 18, 0);
        ModelUtil.addCube(pd, "shoulder", 0, 35, -4, -1, -1, 8, 2, 2, 0, 7.999f, 0);
        ModelUtil.addCube(pd, "chest_front", 30, 0, -3.5f, -2.5f, 2.501f, 7, 5, 0, 0, 9.5f, 0);
        ModelUtil.addCube(pd, "top_chest_back", 15, 0, -2.5f, -1, -2.5f, 5, 2, 0, 0, 4, 0);
        ModelUtil.addCube(pd, "bottom_chest_back", 15, 3, -3.5f, -3.5f, -2.501f, 7, 7, 0, 0, 8.5f, 0);
        ModelUtil.addCube(pd, "top_right_chest", 74, 3, -1.5f, -0.5f, 0, 3, 1, 0, 3.5f, 5.5f, -1, 0, -(float) (Math.PI / 2), 0);
        ModelUtil.addCube(pd, "middle_right_chest", 56, 5, -2.5f, -0.5f, 0, 5, 1, 0, 3.5f, 6.5f, 0, 0, -(float) (Math.PI / 2), 0);
        ModelUtil.addCube(pd, "bottom_right_chest", 0, 14, -2.5f, -1.5f, 0, 5, 3, 0, 3.501f, 10.5f, 0, 0, -(float) (Math.PI / 2), 0);
        ModelUtil.addCube(pd, "right_arm", 0, 46, 0, -1, -1, 2, 13, 2, 4, 8, 0);
        ModelUtil.addCube(pd, "right_hand", 0, 0, 2, 7, -1, 1, 4, 2, 4, 8, 0);
        ModelUtil.addCube(pd, "top_right_hand_front", 80, 12, -1, 7, 1, 4, 1, 1, 4, 8, 0);
        ModelUtil.addCube(pd, "top_right_hand_inside", 36, 16, -1, 7, -1, 1, 1, 2, 4, 8, 0);
        ModelUtil.addMirroredCube(pd, "top_right_hand_back", 56, 12, -1, 7, -2, 4, 1, 1, 4, 8, 0);
        ModelUtil.addCube(pd, "bottom_right_hand_front", 92, 12, -1, 10, 1, 4, 1, 1, 4, 8, 0);
        ModelUtil.addCube(pd, "bottom_right_hand_inside", 20, 16, -1, 10, -1, 1, 1, 2, 4, 8, 0);
        ModelUtil.addCube(pd, "bottom_right_hand_back", 32, 12, -1, 10, -2, 4, 1, 1, 4, 8, 0);
        ModelUtil.addCube(pd, "top_left_chest", 67, 3, -1.5f, -0.5f, 0, 3, 1, 0, -3.5f, 5.5f, -1, 0, -(float) (Math.PI / 2), 0);
        ModelUtil.addCube(pd, "middle_left_chest", 45, 5, -2.5f, -0.5f, 0, 5, 1, 0, -3.5f, 6.5f, 0, 0, -(float) (Math.PI / 2), 0);
        ModelUtil.addCube(pd, "bottom_left_chest", 0, 14, -2.5f, -1.5f, 0, 5, 3, 0, -3.501f, 10.5f, 0, 0, -(float) (Math.PI / 2), 0);
        ModelUtil.addCube(pd, "left_arm", 8, 46, -2, -1, -1, 2, 13, 2, -4, 8, 0);
        ModelUtil.addCube(pd, "left_hand", 7, 0, -3, 7, -1, 1, 4, 2, -4, 8, 0);
        ModelUtil.addCube(pd, "top_left_hand_front", 68, 12, -3, 7, 1, 4, 1, 1, -4, 8, 0);
        ModelUtil.addCube(pd, "top_left_hand_inside", 28, 16, 0, 7, -1, 1, 1, 2, -4, 8, 0);
        ModelUtil.addCube(pd, "top_left_hand_back", 20, 12, -3, 7, -2, 4, 1, 1, -4, 8, 0);
        ModelUtil.addCube(pd, "bottom_left_hand_front", 104, 12, -3, 10, 1, 4, 1, 1, -4, 8, 0);
        ModelUtil.addCube(pd, "bottom_left_hand_inside", 44, 16, 0, 10, -1, 1, 1, 2, -4, 8, 0);
        ModelUtil.addMirroredCube(pd, "bottom_left_hand_back", 44, 12, -3, 10, -2, 4, 1, 1, -4, 8, 0);

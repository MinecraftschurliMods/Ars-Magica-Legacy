...
public class FireGuardianModel extends EntityModel<FireGuardian> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        torso.addOrReplaceChild("torso9", CubeListBuilder.create()
        ...
        torso.addOrReplaceChild("torso7", CubeListBuilder.create()
        ...
        torso.addOrReplaceChild("torso4", CubeListBuilder.create()
        ...
        torso.addOrReplaceChild("torso3", CubeListBuilder.create()
        ...
        torso.addOrReplaceChild("torso2", CubeListBuilder.create()
        ...
        torso.addOrReplaceChild("torso1", CubeListBuilder.create()
        ...
        torso.addOrReplaceChild("neck6", CubeListBuilder.create()
        ...
        torso.addOrReplaceChild("neck5", CubeListBuilder.create()
        ...
        torso.addOrReplaceChild("neck4", CubeListBuilder.create()
        ...
        torso.addOrReplaceChild("neck3", CubeListBuilder.create()
        ...
        torso.addOrReplaceChild("neck2", CubeListBuilder.create()

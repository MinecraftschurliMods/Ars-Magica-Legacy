...
public class FireGuardianModel extends EntityModel<FireGuardian> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        ModelUtil.addCube(pd, "nose_front", 48, 20, -2.5f, -3.5f, -14, 5, 3, 2, 0, -18, 0);
        ModelUtil.addCube(pd, "nose_back", 0, 46, -3.5f, -4, -12, 7, 4, 3, 0, -18, 0);
        ModelUtil.addCube(pd, "head", 20, 34, -4, -5, -9, 8, 5, 8, 0, -18, 0);
        ModelUtil.addCube(pd, "right_ear_front", 48, 25, 4, -3.5f, -6, 2, 3, 6, 0, -18, 0);
        ModelUtil.addCube(pd, "right_ear_back", 52, 34, 4.5f, -3, 0, 1, 2, 5, 0, -18, 0);
        ModelUtil.addCube(pd, "right_arm", 56, 2, 8, -1, 1, 2, 16, 2, 0, -13, 0);
        ModelUtil.addCube(pd, "right_hand", 0, 33, 6, 15, 0, 6, 16, 4, 0, -13, 0);
        ModelUtil.addCube(pd, "left_ear_front", 48, 25, -6, -3.5f, -6, 2, 3, 6, 0, -18, 0);
        ModelUtil.addCube(pd, "left_ear_back", 52, 34, -5.5f, -3, 0, 1, 2, 5, 0, -18, 0);
        ModelUtil.addCube(pd, "left_arm", 56, 2, -10, -1, 1, 2, 16, 2, 0, -13, 0);
        ModelUtil.addCube(pd, "left_hand", 0, 33, -12, 15, 0, 6, 16, 4, 0, -13, 0);
        ModelUtil.addCube(pd, "neck1", 20, 30, -1, -33, -15, 2, 1, 2, 0, 0, 30, (float) (5 * Math.PI / 24), 0, 0);
        ModelUtil.addCube(pd, "neck2", 16, 28, -2, -32.25f, -16.25f, 4, 1, 4, 0, 0, 30, (float) (5 * Math.PI / 24), 0, 0);
        ModelUtil.addCube(pd, "neck3", 12, 26, -3, -31.5f, -17, 6, 1, 6, 0, 0, 30, (float) (5 * Math.PI / 24), 0, 0);
        ModelUtil.addCube(pd, "neck4", 8, 24, -4, -30.75f, -18.5f, 8, 1, 8, 0, 0, 30, (float) (73 * Math.PI / 360), 0, 0);
        ModelUtil.addCube(pd, "neck5", 4, 22, -5, -29.5f, -21, 10, 1, 10, 0, 0, 30, (float) (17 * Math.PI / 90), 0, 0);
        ModelUtil.addCube(pd, "neck6", 0, 20, -6, -27.75f, -24, 12, 1, 12, 0, 0, 30, (float) (Math.PI / 6), 0, 0);
        ModelUtil.addCube(pd, "body1", 0, 0, -7, -26.25f, -25.75f, 14, 6, 14, 0, 0, 30, (float) (11 * Math.PI / 72), 0, 0);
        ModelUtil.addCube(pd, "body2", 3, 3, -6.5f, -18.75f, -27.25f, 13, 5, 12, 0, 0, 30, (float) (7 * Math.PI / 72), 0, 0);
        ModelUtil.addCube(pd, "body3", 7, 7, -5.5f, -14, -26.75f, 11, 3, 10, 0, 0, 30, (float) (Math.PI / 12), 0, 0);
        ModelUtil.addCube(pd, "body4", 11, 9, -4.5f, -11.25f, -26.5f, 9, 3, 8, 0, 0, 30, (float) (5 * Math.PI / 72), 0, 0);
        ModelUtil.addCube(pd, "body5", 15, 11, -3.5f, -7.5f, -26, 7, 3, 6, 0, 0, 30, (float) (Math.PI / 24), 0, 0);
        ModelUtil.addCube(pd, "body6", 19, 12, -2.5f, -2.5f, -25, 5, 4, 4, 0, 0, 30);
        ModelUtil.addCube(pd, "body7", 21, 12, -2, 3.25f, -24, 4, 5, 3, 0, 0, 30, -(float) (Math.PI / 36), 0, 0);
        ModelUtil.addCube(pd, "body8", 24, 11, -1, 9.25f, -23, 2, 7, 2, 0, 0, 30, -(float) (Math.PI / 24), 0, 0);
        ModelUtil.addCube(pd, "body9", 26, 12, -0.5f, 15.25f, -22.75f, 1, 7, 1, 0, 0, 30, -(float) (Math.PI / 24), 0, 0);

...
public class WaterGuardianModel extends EntityModel<WaterGuardian> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        ModelUtil.addCube(partdefinition, "top_head", 19, 32, -4f, -0.5f, -4f, 8f, 1f, 8f, 0f, -0.5f, 0f);
        ModelUtil.addCube(partdefinition, "middle_head", 23, 42, -5f, -0.5f, -5f, 10f, 1f, 10f, 0f, 0.5f, 0f);
        ModelUtil.addCube(partdefinition, "bottom_head", 19, 32, -4f, -0.5f, -4f, 8f, 1f, 8f, 0f, 2.5f, 0f);
        ...
        ModelUtil.addCube(partdefinition, "inner_orb1", 0, 19, -11f, 8.5f, -0.5f, 2f, 1f, 1f, 0f, -6.5f, 0f, 0f, -(float) (Math.PI / 2), 0f);
        ModelUtil.addCube(partdefinition, "outer_orb1", 0, 15, -1f, -10.5f, -10f, 2f, 1f, 2f, 0f, -6.5f, 0f, (float) (Math.PI / 2), 0f, 0f);
        ModelUtil.addCube(partdefinition, "inner_orb2", 0, 19, -11f, 8.5f, -0.5f, 2f, 1f, 1f, 0f, -6.5f, 0f, 0f, -(float) Math.PI, 0f);
        ModelUtil.addCube(partdefinition, "outer_orb2", 0, 15, -1f, -10.5f, -10f, 2f, 1f, 2f, 0f, -6.5f, 0f, (float) (Math.PI / 2), -(float) (Math.PI / 2), 0f);
        ModelUtil.addCube(partdefinition, "inner_orb3", 0, 19, -11f, 8.5f, -0.5f, 2f, 1f, 1f, 0f, -6.5f, 0f, 0f, (float) (Math.PI / 2), 0f);
        ModelUtil.addCube(partdefinition, "outer_orb3", 0, 15, -1f, -10.5f, -10f, 2f, 1f, 2f, 0f, -6.5f, 0f, (float) (Math.PI / 2), -(float) Math.PI, 0f);
        ModelUtil.addCube(partdefinition, "inner_orb4", 0, 19, -11f, 8.5f, -0.5f, 2f, 1f, 1f, 0f, -6.5f, 0f, 0f, 0f, 0f);
        ModelUtil.addCube(partdefinition, "outer_orb4", 0, 15, -1f, -10.5f, -10f, 2f, 1f, 2f, 0f, -6.5f, 0f, (float) (Math.PI / 2), (float) (Math.PI / 2), 0f);
        ModelUtil.addCube(partdefinition, "rod1", 0, 0, 9.5f, -0.5f, 4f, 1f, 1f, 10f, 0f, 12f, 0f, (float) (Math.PI / 2), (float) (3 * Math.PI / 4), 0f);
        ModelUtil.addCube(partdefinition, "rod2", 0, 0, 9.5f, -0.5f, 4f, 1f, 1f, 10f, 0f, 12f, 0f, (float) (Math.PI / 2), -(float) (3 * Math.PI / 4), 0f);
        ModelUtil.addCube(partdefinition, "rod3", 0, 0, 9.5f, -0.5f, 4f, 1f, 1f, 10f, 0f, 12f, 0f, (float) (Math.PI / 2), -(float) (Math.PI / 4), 0f);
        ModelUtil.addCube(partdefinition, "rod4", 0, 0, 9.5f, -0.5f, 4f, 1f, 1f, 10f, 0f, 12f, 0f, (float) (Math.PI / 2), (float) (Math.PI / 4), 0f);
        ...
        ModelUtil.addCube(partdefinition, "outer_tentacle1", 0, 49, -4f, 0f, -4f, 1f, 14f, 1f, 0f, 6f, 0f);
        ModelUtil.addCube(partdefinition, "outer_tentacle2", 0, 49, -4f, 0f, 3f, 1f, 14f, 1f, 0f, 6f, 0f);
        ModelUtil.addCube(partdefinition, "outer_tentacle3", 0, 49, 3f, 0f, 3f, 1f, 14f, 1f, 0f, 6f, 0f);
        ModelUtil.addCube(partdefinition, "outer_tentacle4", 0, 49, 3f, 0f, -4f, 1f, 14f, 1f, 0f, 6f, 0f);

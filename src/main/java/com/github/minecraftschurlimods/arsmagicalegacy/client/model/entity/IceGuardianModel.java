...
public class IceGuardianModel extends EntityModel<IceGuardian> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        ModelUtil.addCube(pd, "right_eye", 89, 9, 2, -6, -4.5f, 2, 1, 9, 0, -15, 0);
        ModelUtil.addCube(pd, "left_eye", 89, 9, -4, -6, -4.5f, 2, 1, 9, 0, -15, 0);
        ModelUtil.addCube(pd, "top_head", 79, 31, -5, -10, -5, 10, 4, 10, 0, -15, 0);
        ModelUtil.addCube(pd, "middle_head", 83, 20, -5, -6, -3, 10, 2, 8, 0, -15, 0);
        ModelUtil.addCube(pd, "bottom_head", 79, 31, -5, -4, -5, 10, 4, 10, 0, -15, 0);
        ModelUtil.addCube(pd, "top_body", 69, 46, -7, 2.5f, -5.5f, 14, 7, 11, 0, -9.5f, -6, (float) (Math.PI / 2), 0, 0);
        ModelUtil.addCube(pd, "middle_body", 33, 29, -3, -3, -5, 8, 8, 10, 0, -4, 0, 0, 0, (float) (Math.PI / 4));
        ModelUtil.addCube(pd, "bottom_body", 37, 48, -2, -6, -4, 8, 8, 8, 0, 4, 0, 0, 0, -(float) (Math.PI / 4));
        ModelUtil.addCube(pd, "core1", 0, 52, -3, -3, -3, 6, 6, 6, 0, 15, 0);
        ModelUtil.addCube(pd, "core2", 0, 52, -3, -3, -3, 6, 6, 6, 0, 15, 0);
        ModelUtil.addCube(pd, "core3", 0, 52, -3, -3, -3, 6, 6, 6, 0, 15, 0);
        ModelUtil.addCube(pd, "cube1", 120, 17, -1.5f, -1.5f, -9, 3, 3, 1, 0, 15, 0);
        ModelUtil.addCube(pd, "cube2", 120, 17, -1.5f, -1.5f, -9, 3, 3, 1, 0, 15, 0, 0, (float) (Math.PI / 2), 0);
        ModelUtil.addCube(pd, "cube3", 120, 17, -1.5f, -1.5f, -9, 3, 3, 1, 0, 15, 0, 0, (float) Math.PI, 0);
        ModelUtil.addCube(pd, "cube4", 120, 17, -1.5f, -1.5f, -9, 3, 3, 1, 0, 15, 0, 0, -(float) (Math.PI / 2), 0);
        ModelUtil.addCube(pd, "rod1", 120, 22, -10, -6, -1, 2, 12, 2, 0, 15, 0, 0, -(float) (Math.PI / 4), 0);
        ModelUtil.addMirroredCube(pd, "rod2", 120, 37, -10, -6, -1, 2, 12, 2, 0, 15, 0, 0, (float) (Math.PI / 4), 0);
        ModelUtil.addCube(pd, "rod3", 120, 22, -10, -6, -1, 2, 12, 2, 0, 15, 0, 0, (float) (3 * Math.PI / 4), 0);
        ModelUtil.addMirroredCube(pd, "rod4", 120, 37, -10, -6, -1, 2, 12, 2, 0, 15, 0, 0, -(float) (3 * Math.PI / 4), 0);
        ModelUtil.addCube(pd, "right_shoulder", 25, 6, -5, -5, -6, 10, 10, 12, -7, -8, 0, 0, 0, (float) (Math.PI / 4));
        ModelUtil.addMirroredCube(pd, "right_core1", 112, 8, -2, -2, -2, 4, 4, 4, 13, -14.5f, 0);
        ModelUtil.addMirroredCube(pd, "right_core2", 112, 8, -2, -2, -2, 4, 4, 4, 13, -14.5f, 0);
        ModelUtil.addMirroredCube(pd, "right_core3", 112, 8, -2, -2, -2, 4, 4, 4, 13, -14.5f, 0);
        ModelUtil.addCube(pd, "right_arm", 0, 6, 17, 0, -3, 6, 26, 6, 0, -10, 0);
        ModelUtil.addMirroredCube(pd, "right_hand", 69, 2, 17, 27, -2, 6, 1, 5, 0, -10, 0);
        ModelUtil.addMirroredCube(pd, "right_outer_fingers", 91, 2, 22, 26, -2, 1, 1, 5, 0, -10, 0);
        ModelUtil.addMirroredCube(pd, "right_inner_fingers", 91, 2, 17, 26, -2, 1, 1, 5, 0, -10, 0);
        ModelUtil.addMirroredCube(pd, "right_thumb", 120, 54, 17, 26, -3, 3, 2, 1, 0, -10, 0);
        ModelUtil.addCube(pd, "left_shoulder", 25, 6, -5, -5, -6, 10, 10, 12, 7, -8, 0, 0, 0, -(float) (Math.PI / 4));
        ModelUtil.addCube(pd, "left_core1", 112, 8, -2, -2, -2, 4, 4, 4, -13, -14.5f, 0);
        ModelUtil.addCube(pd, "left_core2", 112, 8, -2, -2, -2, 4, 4, 4, -13, -14.5f, 0);
        ModelUtil.addCube(pd, "left_core3", 112, 8, -2, -2, -2, 4, 4, 4, -13, -14.5f, 0);
        ModelUtil.addCube(pd, "left_arm", 0, 6, -23, 0, -3, 6, 26, 6, 0, -10, 0);
        ModelUtil.addCube(pd, "left_hand", 69, 2, -23, 27, -2, 6, 1, 5, 0, -10, 0);
        ModelUtil.addCube(pd, "left_outer_fingers", 91, 2, -23, 26, -2, 1, 1, 5, 0, -10, 0);
        ModelUtil.addCube(pd, "left_inner_fingers", 91, 2, -18, 26, -2, 1, 1, 5, 0, -10, 0);
        ModelUtil.addCube(pd, "left_thumb", 120, 54, -20, 26, -3, 3, 2, 1, 0, -10, 0);

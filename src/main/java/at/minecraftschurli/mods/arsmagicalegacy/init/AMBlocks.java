...
import at.minecraftschurli.mods.arsmagicalegacy.block.LiquidEtheriumBlock;
...
public interface AMBlocks {
    ...
    DeferredBlock<LiquidEtheriumBlock>         LIQUID_ETHERIUM             = register("liquid_etherium",             LiquidEtheriumBlock::new, BlockBehaviour.Properties::of);

...
public interface AMItems {
    ...
    DeferredItem<Item>                                  MAGITECH_GOGGLES                 = ITEMS.registerSimpleItem("magitech_goggles", p -> AMEquipmentUtil.armorProperties(p, EquipmentSlot.HEAD, SoundEvents.ARMOR_EQUIP_LEATHER, AMEquipmentUtil.MAGITECH_GOGGLES_ASSET_ID).durability(100));
    DeferredItem<Item>                                  MAGE_HELMET                      = ITEMS.registerSimpleItem("mage_helmet", p -> AMEquipmentUtil.mageArmorProperties(p, ArmorType.HELMET, 2));
    DeferredItem<Item>                                  MAGE_CHESTPLATE                  = ITEMS.registerSimpleItem("mage_chestplate", p -> AMEquipmentUtil.mageArmorProperties(p, ArmorType.CHESTPLATE, 6));
    DeferredItem<Item>                                  MAGE_LEGGINGS                    = ITEMS.registerSimpleItem("mage_leggings", p -> AMEquipmentUtil.mageArmorProperties(p, ArmorType.LEGGINGS, 4));
    DeferredItem<Item>                                  MAGE_BOOTS                       = ITEMS.registerSimpleItem("mage_boots", p -> AMEquipmentUtil.mageArmorProperties(p, ArmorType.BOOTS, 2));
    DeferredItem<Item>                                  BATTLEMAGE_HELMET                = ITEMS.registerSimpleItem("battlemage_helmet", p -> AMEquipmentUtil.battlemageArmorProperties(p, ArmorType.HELMET, 3));
    DeferredItem<Item>                                  BATTLEMAGE_CHESTPLATE            = ITEMS.registerSimpleItem("battlemage_chestplate", p -> AMEquipmentUtil.battlemageArmorProperties(p, ArmorType.CHESTPLATE, 8));
    DeferredItem<Item>                                  BATTLEMAGE_LEGGINGS              = ITEMS.registerSimpleItem("battlemage_leggings", p -> AMEquipmentUtil.battlemageArmorProperties(p, ArmorType.LEGGINGS, 6));
    DeferredItem<Item>                                  BATTLEMAGE_BOOTS                 = ITEMS.registerSimpleItem("battlemage_boots", p -> AMEquipmentUtil.battlemageArmorProperties(p, ArmorType.BOOTS, 3));
    ...
    DeferredItem<Item>                                  LIGHTNING_CHARM                  = ITEMS.registerSimpleItem("lightning_charm");
    DeferredItem<NatureScytheItem>                      NATURE_SCYTHE                    = ITEMS.registerItem("nature_scythe", NatureScytheItem::new);
    DeferredItem<Item>                                  LIFE_WARD                        = ITEMS.registerSimpleItem("life_ward");
    DeferredItem<ArcaneSpellBookItem>                   ARCANE_SPELL_BOOK                = ITEMS.registerItem("arcane_spell_book", ArcaneSpellBookItem::new);
    DeferredItem<Item>                                  ENDER_BOOTS                      = ITEMS.registerSimpleItem("ender_boots", AMEquipmentUtil::enderBootsProperties);

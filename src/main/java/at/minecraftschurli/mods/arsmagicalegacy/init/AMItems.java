...
public interface AMItems {
    ...
    DeferredItem<Item>                                  MAGITECH_GOGGLES                 = ITEMS.registerSimpleItem("magitech_goggles", p -> ArmorItemUtil.armorProperties(p, EquipmentSlot.HEAD, SoundEvents.ARMOR_EQUIP_LEATHER, ArmorItemUtil.MAGITECH_GOGGLES_ASSET_ID).durability(100));
    DeferredItem<Item>                                  MAGE_HELMET                      = ITEMS.registerSimpleItem("mage_helmet", p -> ArmorItemUtil.mageArmor(p, ArmorType.HELMET, 2));
    DeferredItem<Item>                                  MAGE_CHESTPLATE                  = ITEMS.registerSimpleItem("mage_chestplate", p -> ArmorItemUtil.mageArmor(p, ArmorType.CHESTPLATE, 6));
    DeferredItem<Item>                                  MAGE_LEGGINGS                    = ITEMS.registerSimpleItem("mage_leggings", p -> ArmorItemUtil.mageArmor(p, ArmorType.LEGGINGS, 4));
    DeferredItem<Item>                                  MAGE_BOOTS                       = ITEMS.registerSimpleItem("mage_boots", p -> ArmorItemUtil.mageArmor(p, ArmorType.BOOTS, 2));
    DeferredItem<Item>                                  BATTLEMAGE_HELMET                = ITEMS.registerSimpleItem("battlemage_helmet", p -> ArmorItemUtil.battlemageArmor(p, ArmorType.HELMET, 3));
    DeferredItem<Item>                                  BATTLEMAGE_CHESTPLATE            = ITEMS.registerSimpleItem("battlemage_chestplate", p -> ArmorItemUtil.battlemageArmor(p, ArmorType.CHESTPLATE, 8));
    DeferredItem<Item>                                  BATTLEMAGE_LEGGINGS              = ITEMS.registerSimpleItem("battlemage_leggings", p -> ArmorItemUtil.battlemageArmor(p, ArmorType.LEGGINGS, 6));
    DeferredItem<Item>                                  BATTLEMAGE_BOOTS                 = ITEMS.registerSimpleItem("battlemage_boots", p -> ArmorItemUtil.battlemageArmor(p, ArmorType.BOOTS, 3));

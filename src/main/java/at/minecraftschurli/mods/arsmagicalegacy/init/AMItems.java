...
public interface AMItems {
    ...
    DeferredItem<Item>                                  MAGITECH_GOGGLES                 = ITEMS.registerSimpleItem("magitech_goggles", p -> p.humanoidArmor(AMArmorMaterials.MAGITECH_GOGGLES, ArmorType.HELMET).stacksTo(1).durability(100));
    DeferredItem<ManaArmorItem>                         MAGE_HELMET                      = ITEMS.registerItem("mage_helmet", p -> new ManaArmorItem(p.humanoidArmor(AMArmorMaterials.MAGE, ArmorType.HELMET).stacksTo(1).component(AMDataComponents.MANA_REPAIR_COST, 2.0)));
    DeferredItem<ManaArmorItem>                         MAGE_CHESTPLATE                  = ITEMS.registerItem("mage_chestplate", p -> new ManaArmorItem(p.humanoidArmor(AMArmorMaterials.MAGE, ArmorType.CHESTPLATE).stacksTo(1).component(AMDataComponents.MANA_REPAIR_COST, 2.0)));
    DeferredItem<ManaArmorItem>                         MAGE_LEGGINGS                    = ITEMS.registerItem("mage_leggings", p -> new ManaArmorItem(p.humanoidArmor(AMArmorMaterials.MAGE, ArmorType.LEGGINGS).stacksTo(1).component(AMDataComponents.MANA_REPAIR_COST, 2.0)));
    DeferredItem<ManaArmorItem>                         MAGE_BOOTS                       = ITEMS.registerItem("mage_boots", p -> new ManaArmorItem(p.humanoidArmor(AMArmorMaterials.MAGE, ArmorType.BOOTS).stacksTo(1).component(AMDataComponents.MANA_REPAIR_COST, 2.0)));
    DeferredItem<ManaArmorItem>                         BATTLEMAGE_HELMET                = ITEMS.registerItem("battlemage_helmet", p -> new ManaArmorItem(p.humanoidArmor(AMArmorMaterials.BATTLEMAGE, ArmorType.HELMET).stacksTo(1).component(AMDataComponents.MANA_REPAIR_COST, 4.0)));
    DeferredItem<ManaArmorItem>                         BATTLEMAGE_CHESTPLATE            = ITEMS.registerItem("battlemage_chestplate", p -> new ManaArmorItem(p.humanoidArmor(AMArmorMaterials.BATTLEMAGE, ArmorType.CHESTPLATE).stacksTo(1).component(AMDataComponents.MANA_REPAIR_COST, 4.0)));
    DeferredItem<ManaArmorItem>                         BATTLEMAGE_LEGGINGS              = ITEMS.registerItem("battlemage_leggings", p -> new ManaArmorItem(p.humanoidArmor(AMArmorMaterials.BATTLEMAGE, ArmorType.LEGGINGS).stacksTo(1).component(AMDataComponents.MANA_REPAIR_COST, 4.0)));
    DeferredItem<ManaArmorItem>                         BATTLEMAGE_BOOTS                 = ITEMS.registerItem("battlemage_boots", p -> new ManaArmorItem(p.humanoidArmor(AMArmorMaterials.BATTLEMAGE, ArmorType.BOOTS).stacksTo(1).component(AMDataComponents.MANA_REPAIR_COST, 4.0)));

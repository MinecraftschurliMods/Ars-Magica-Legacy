...
public final class ArsMagicaAPIImpl implements ArsMagicaAPI {
    ...
    @Override
    public Registry<ISkillPoint> getSkillPointRegistry() {
        return RegistryAccess.BUILTIN.get().registryOrThrow(ISkillPoint.REGISTRY_KEY);
    }

    @Override
    public Registry<IAffinity> getAffinityRegistry() {
        return RegistryAccess.BUILTIN.get().registryOrThrow(IAffinity.REGISTRY_KEY);
    }

    @Override
    public Registry<ISpellPart> getSpellPartRegistry() {
        return RegistryAccess.BUILTIN.get().registryOrThrow(ISpellPart.REGISTRY_KEY);
    }

    @Override
    public Registry<IAbility> getAbilityRegistry() {
        return RegistryAccess.BUILTIN.get().registryOrThrow(IAbility.REGISTRY_KEY);
    }
